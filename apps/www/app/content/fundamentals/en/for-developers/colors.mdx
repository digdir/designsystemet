...
This article assumes that you have already defined the colors you will use with the help of the [Theme Builder](/en/fundamentals/for-designers/custom-theme).
