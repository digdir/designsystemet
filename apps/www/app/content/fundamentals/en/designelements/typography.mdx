...
We have a total of 10 sizes in Designsystemet: 12, 14, 16, 18, 21, 24, 30, 36, 48, and 60px. The default text size for `paragraph` is `md`, which corresponds to 18px.
...
Dynamic font size without breakpoints was standard in Designsystemet for most of the Beta period. Dynamic font sizes, or "_Fluid typography_", have some disadvantages that made us choose a static font scale instead.
