...
In the theme builder, you can define colors and other visual settings for your design. See the guide [Use Designsystemet with your own theme](/en/fundamentals/for-designers/own-theme) to get started.
