...
3. Go to the [Theme Builder](https://theme.designsystemet.no) and generate the color scale based on your brand colors. Keep the same color names and don't remove colors (This only works with [option 2](/en/fundamentals/for-designers/custom-theme#option-2-with-connection).)
