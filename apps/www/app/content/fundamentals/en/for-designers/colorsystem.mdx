...
## Designsystemet's theme generator
...
When you have generated the scales, you can [use the new color codes in Designsystemet](/en/fundamentals/for-designers/own-theme), so that all components follow your brand.
