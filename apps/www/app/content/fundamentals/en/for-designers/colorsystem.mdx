...
When you have generated the scales, you can [use the new color codes in the Design System](/en/fundamentals/for-designers/custom-theme), so that all components follow your brand.
