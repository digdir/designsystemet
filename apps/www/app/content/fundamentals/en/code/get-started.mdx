...
To understand how colors, spacing, and typography are handled in code, we also recommend reading about [design tokens](/en/fundamentals/design-tokens/design-tokens).
