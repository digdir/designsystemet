...
- `data-color-scheme` which changes the color mode (corresponds with `Appearance › Color scheme` in Figma)
- `data-color` which changes the color (corresponds with `Appearance › Color` in Figma)
