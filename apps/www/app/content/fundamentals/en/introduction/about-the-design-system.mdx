...
Designsystemet is established as a product in Digdir under the product group “Portals and user experience”. The product group has a product council with 13 different organisations.

The development team consists of designers and developers from Digdir, the Brønnøysund Register Centre, the Norwegian Food Safety Authority, the Directorate for Education and Training and KS Digital. In addition, we collaborate with the design system teams at Nav, the Norwegian Tax Administration, Oslo Municipality, the Police and Entur to establish shared interaction patterns across sectors. We also have a broad network of contributors from other organisations who help shape Designsystemet. Read more about the [collaboration](/en/fundamentals/introduction/collaboration).

Designsystemet also aims to facilitate an active and inclusive community where organisations can share experiences, ask questions and learn from one another. The goal is to create an environment where both designers and developers can discuss challenges, share solutions and contribute to the ongoing development of Designsystemet. You can participate in the community through [Slack](http://designsystemet.no/slack) and [Github](https://github.com/digdir/designsystemet/discussions/categories/samarbeid-m%C3%B8nster-for-innbyggertjenester), where the dialogue is open to everyone who wishes to take part.
