...
* Color - Select which color to use on components
...
In code, color scheme can be set by using the attribute `data-color-scheme`.
...
## Color
To offer the ability to change colors on components, we've created a *Color* mode. It contains all the colors you entered in the theme builder. By selecting a color mode in Figma, you control which of your theme colors is used.

The modes are cascading, so you can set them on the entire design or just on specific frame. This allows you to easily customize the design and adapt it to different contexts and needs.

In code, color can be set by using the attribute `data-color`.

Here's how to change the color on a component:
...
In the theme builder, you can define colors and other visual settings for your design. See the guide [Use Designsystemet with your own theme](/en/fundamentals/start-here/own-theme) to get started.
