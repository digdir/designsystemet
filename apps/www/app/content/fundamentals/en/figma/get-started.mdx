...
Read more about [color tokens](/en/fundamentals/design-tokens/colors) and what they are used for.

### Typography styles

For all text, you should use typography styles or typography components. This ensures that we have a consistent expression, correct use of spacing, sizes, and weights. Read more about [typography](/en/fundamentals/design-tokens/typography).
