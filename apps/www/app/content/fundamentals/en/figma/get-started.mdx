---
title: Get started in Figma
sidebar_title: Get started in Figma
...
Are you going to use Designsystemet with your own colors and branding? See the guide for [setting up Designsystemet with your own theme](/en/fundamentals/themebuilder/own-theme).
...
The components support different brands and modes. To set up your own profiles, see the guide "[Build your theme](/en/fundamentals/themebuilder/own-theme)"
