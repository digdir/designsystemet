...
[Popover](https://storybook.designsystemet.no/?path=/docs/komponenter-popover--docs) er en komponent som legger seg over annet innhold. Dette tydeliggjøres ved bruk av en medium skygge.
