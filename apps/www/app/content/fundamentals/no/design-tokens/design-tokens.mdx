...
sidebar_title: Hva er Design Tokens
...
Noen av variablene er lagt opp til å være tema-baserte, det vil si at de tar utgangspunkt i din merkevare med de fargene og preferansene du selv velger i [Temabyggeren](https://theme.designsystemet.no/). 
