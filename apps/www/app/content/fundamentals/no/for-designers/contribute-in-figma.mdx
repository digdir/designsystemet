...
- Tenke på om den er i tråd med [designprinsippene](/fundamentals/introduksjon/designprinsipper) og om den passer inn i helheten
...
[Se hvordan du kobler pluginen opp mot våre design tokens](/fundamentals/for-designere/kom-i-gang#bruk-egen-fargepalett-på-komponentene).
