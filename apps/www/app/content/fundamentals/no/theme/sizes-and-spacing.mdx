...
description: Hvordan størrelser og avstander er definert og brukt i Designsystemet.
date: 2025-01-03
category: Tema
color: red
icon: RulerIcon
published: true
order: 15
search_terms: sizing, padding, margins, spacing, størrelsar, avstandar
---
...
<Image
  src='/img/fundamentals/theme/sizes-and-spacing/component-size-buttons.png'
...
<Image
  src='/img/fundamentals/theme/sizes-and-spacing/component-size-balance.png'
  alt='Tabell som viser tekststørrelser og vekting, og i hviken grad de oppfyller kontrastkravet.'
  boxShadow={true}
...
<Image
  src='/img/fundamentals/theme/sizes-and-spacing/component-size-example.png'
