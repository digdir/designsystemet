...
published: true
order: 1
search_terms: multibrand, multiple, theming, themes
---
...
**Denne sida føreset at du har lest "[Bygg ditt tema](/no/fundamentals/start-here/own-theme)".**
...
```json
{
  "output": [
    ...
    { "type": "css", "dir": "./some-org-css", "tokenDir": "./some-org-dt" }
  ],
  "themes": {
    "some-org": {
      "colors": {
...
```json
{
  "output": [
    ...
    { "type": "css", "dir": "./other-org-css", "tokenDir": "./other-org-dt" }
  ],
  "themes": {
    "other-org": {
      "colors": {
...
Legg merke til at me har ulike `output`-mapper i desse to config filene, slik at design tokens og CSS for kvart tema blir lagt i kvar sine mapper.
</Alert>
