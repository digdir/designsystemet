...
Koden i SVG-fila i eksempelet over
```SVG
<svg 
  width='24' 
  height='24' 
...
<svg width="80" height="80" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
  <rect x="..." fill="var(--logo-color-part1)"/>
  <rect x="..." fill="var(--logo-color-part2)"/>
  <rect x="..." fill="var(--logo-color-part3)"/>
  <rect x="..." fill="var(--logo-color-part4)"/>
</svg>
```
