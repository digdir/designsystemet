...
description: Hvordan skygger er definert og brukes i Designsystemet.
date: 2023-04-10
category: Tema
color: red
icon: MoonIcon
...
Skygger er ikke ment for bruk i mørk modus, da de er basert på mørkere fargetoner. For å skape hierarki og kontrast i mørk modus er det bedre å benytte andre virkemidler som for eksempel lyse kanter.
...
[Popover](/no/components/docs/popover/overview) er en komponent som legger seg over annet innhold. Dette tydeliggjøres ved bruk av en medium skygge.
