...
Det anbefales at du også leser om [bygg ditt tema](/no/fundamentals/start-here/own-theme).
...
<ds-tabs class="ds-tabs" data-wide-content>
  ...
  import '@digdir/designsystemet-css/theme'; /* eller din tema fil */
  ```
  </ds-tabpanel>
</ds-tabs>
...
<p>
`background` og `color` blir automatisk definert på `body`-elementet, slik at vi ivaretar [universell utforming (w3.org)](https://www.w3.org/WAI/WCAG21/Understanding/resize-text.html) og får samme font og farge på tvers.
