...
## Data attributter
Designsystemet tilbyr flere data attributter for å styre temaet til komponentene og innholdet i CSS custom properties.
Data attributtene kan settes på et hvilket som helst HTML-element og arves automatisk av alle underliggende elementer.
