...
3. Gå til [Temabyggeren](https://theme.designsystemet.no) og generer fargeskalaen ut i fra dine profilfarger. Behold samme fargenavn og ikke fjern farger (Dette fungerer bare med [alternativ 2](/no/fundamentals/themebuilder/own-theme#alternativ-2-med-kobling).) 
