---
title: Modes i Figma
description: Hvordan modes i Figma fungerer og hvordan du raskt justerer størrelser, farger og typografi. 
date: 2025-02-15
category: Figma
color: yellow
icon: ThemeIcon
published: true
order: 20
search_terms: theming, temaer, farger, størrelser, typografi
---
...
<Image
  src='/img/fundamentals/figma/modes-in-figma/visningstilgang.webp'
...
<Image
  src='/img/fundamentals/figma/modes-in-figma/redigeringstilgang.webp'
...
<Image
  src='/img/fundamentals/figma/modes-in-figma/dev-mode-hele-frame.webp'
...
<ResponsiveIframe
  src='/img/fundamentals/figma/modes-in-figma/theme.mp4'
...
I kode kan color scheme settes via attributten `data-color-scheme`.

Slik bytter du mellom Light og Dark mode i Figma:
<ResponsiveIframe
  src='/img/fundamentals/figma/modes-in-figma/color-scheme.mp4'
...
Modusene arves av alle underliggende lag, så du kan sette dem på hele designet eller enkelt områder. Dette lar deg enkelt tilpasse designet og tilpasse det til forskjellige kontekster og behov.

I kode kan fargemodus settes via attributten `data-color`.

Slik bytter du farge på en komponent:

<ResponsiveIframe
  src='/img/fundamentals/figma/modes-in-figma/support-color.mp4'
...
<ResponsiveIframe
  src='/img/fundamentals/figma/modes-in-figma/typography.mp4'
...
<ResponsiveIframe
  src='/img/fundamentals/figma/modes-in-figma/size.mp4'
...
I temabyggeren kan du definere farger og andre visuelle innstillinger for designet ditt. Se guiden [Bruk designsystemet med eget tema](/no/fundamentals/start-here/own-theme) for å komme i gang. 
