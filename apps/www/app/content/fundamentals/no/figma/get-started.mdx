...
Les mer om [farge-tokens](/no/fundamentals/design-tokens/colors) og hva de brukes til.

### Typografi-stiler

For all tekst bør du bruke typografi-stiler eller typografi-komponenter. Da sikrer vi at vi har et konsistent uttrykk, riktig bruk avstander, størrelser og vekting. Les mer om [typografi](/no/fundamentals/design-tokens/typography).
