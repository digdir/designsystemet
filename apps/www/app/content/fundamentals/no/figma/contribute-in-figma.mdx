---
title: Bidra
description: Vi setter pris på at du hjelper oss å forbedre Designsystemet
date: 2025-06-12
...
## Foreslå nye komponenter eller forbedringer
...
Komponenter under arbeid ligger i egne arbeidsfiler. Når designet er ferdig flyttes komponenten til [Designsystemet - Core UI Kit](https://www.figma.com/@designsystemet). Denne filen blir delt i Figma Community.
...
- Størrelser håndteres med [Modes i Figma](/no/fundamentals/for-designers/modes-in-figma). Du trenger ikke lenger å lage egne varianter for `Small`, `Medium` og `Large`. Så lenge du kobler komponenten til tokens for typografi, avstander og størrelser, vil den tilpasse seg riktig størrelse basert på valgt mode. Dette gjør det både enklere å vedlikeholde komponentene og enklere å bruke dem i ulike størrelser. 
