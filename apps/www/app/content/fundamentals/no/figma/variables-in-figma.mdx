...
Les mer om hvordan den brukes i [modes i Figma](/no/fundamentals/figma/modes-in-figma)

Dette gir deg to viktige fordeler:
1. Du kan bruke egne navn på fargene \
Hvis du hadde brukt selve fargevariablene direkte i komponentene, ville det ført til feil hver gang noen importerte eller byttet ut farger. Ved å bruke Color-moden, refererer komponentene til en abstrakt farge, og du kan endre innholdet uten å påvirke strukturen.
...
- Color: Brukes for fleksible farger, tilsvarende [data-color i kode](/no/fundamentals/code/colors). Du setter en farge-mode (for eksempel `accent`), og komponenten arver riktig farge. Dette gjør det enklere å gjenbruke komponenter uten å lage nye varianter. Modusene er cascading - du kan sette dem på page, frame eller element.
