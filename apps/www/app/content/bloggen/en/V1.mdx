...
- Easier customization of the Design System's components to your own profile and preferences. --> [Set up your own theme](/en/grunnleggende/for-designers/custom-theme).
...
- [The Brønnøysund Register Centre](https://www.brreg.no/) has adopted the Design System on [Business Information](https://virksomhet.brreg.no/nb/oppslag/enheter) and [Support Register](https://stotte.brreg.no/nb/oppslag/stoettetildeling), among others.
...
- [Help page for shared solutions](https://eid.difi.no/nb) uses tokens and components from the Design System.
