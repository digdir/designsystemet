...
description: Insight is incredibly valuable. Therefore we want to make it possible for everyone to share insight in a shared insight library. We are exploring an open source solution for insight in GitHub.
date: 2023-06-29
author: Digdir
...
We’ve also recently created a [GitHub wiki](https://github.com/digdir/innsiktsbibliotek/wiki), where we’ll be publishing and updating future documentation, guides, and other relevant content.
