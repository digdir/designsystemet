...
author: Digdir, KS, Nav, Skatteetaten ++
...
Ledeteksten er den teksten som forteller brukerne hva de skal svare på hvert enkelt spørsmål i et skjema. Du kan bruke beskrivelse for å hjelpe brukerne med å forklare vanskelige begreper, eller fortelle hvorfor de skal svare. Noen kaller ledetekst for spørsmålstekst og beskrivelse for hjelpetekst. 
