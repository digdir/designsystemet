...
published: true
search_terms: skriveråd
---

For å sikre helhetlig begrepsbruk på tvers av produkter har vi i Digdir laget anbefalinger om felles navn på knapper og navigasjonselementer.

I Digdir har vi en rekke produkter og team. For å bevisstgjøre produktteam på språk, innholdesign og mikrotekster, holder vi kurs om ulike emner knyttet til å lage godt innhold.   
...
I noen sammenhenger bør vi tilby kontekst for å presisere hva som blir slettet, lukket eller endret. For eksempel «Slett søknaden», «Lukk produktoversikten», «Endre profilbildet». De gangene vi ikke viser kontekst, men bare verb, bør konteksten være beskrevet i `aria-label` for skjermlesere.
