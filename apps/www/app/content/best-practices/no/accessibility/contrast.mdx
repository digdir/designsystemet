...
description: WCAG 3.0 utforsker en mer presis metode for å kalkulere kontrast. Hvorfor duger ikke dagens standard?
date: 2023-04-11
author: Brønnøysundregistrene
category: Tilgjengelighet
published: true
search_terms: accessibility, contrast, wcag, apca
---

For å sikre god lesbarhet skal all tekst ha tilstrekkelig kontrast mot bakgrunnen. Dette er viktig for alle brukere, særlig under krevende lysforhold. De som trenger dette mest, er svaksynte, dyslektikere og fargeblinde (kilde: [uutilsynet.no](https://www.uutilsynet.no/veiledning/kontrast/48)).
...
<Card data-color='brand3' variant="tinted">
  <h3
    data-size='xs'
  >Gjeldende regelverk, WCAG 2.1</h3>
  <ul>
    <li>
...
<Card data-color='brand2' variant="tinted">
  ...
  <ul>
    ...
    <li>
      **WCAG 3** diskuterer et krav om farge og kontrast, visuell kontrast i tekst
      (sølv): Sørg for tilstrekkelig kontrast mellom tekst i forgrunnen og
      bakgrunnen for teksten. Her foreslås en ny metode, med navn APCA,
...
I WCAG 3.0 diskuteres det en mer presis metode enn dagens standard, for å kalkulere kontrast og sette terskelverdier.
...
For å øke lesbarheten enda mer, har vi ambisjoner om å oppnå kontrast på nivå 4. Det er toppnivået i en modell for nivåer, som ble diskutert i et [foreløpig parkert arbeid om kontrast i WCAG 3.0. (w3.org)](https://www.w3.org/WAI/GL/task-forces/silver/wiki/Visual_Contrast_of_Text_Subgroup)
...
<Card data-color='brand2' variant="tinted">
  **Kontrast i WCAG 3 «visual contrast algorithm»** <br />I WCAG 3 foreslås en
...
## Verktøyet som ble brukt til å teste kontrastverdier

Da Brønnøysundregistrene jobbet med fargesystemet sitt, laget de et eget kontrastverktøy for å teste hvordan kontrastverdier endret seg ut fra tekstfarge, tekststørrelse og font-vekt. Verktøyet viste også hvilke nivåer av krav som var oppfylt, enten det gjaldt WCAG AA, WCAG AAA eller APCA.
...
I variant A har teksten fargen #6D7879og bakgrunnen er hvit. Teksten er sånn passe lesbar. I variant B er teksten svart, og bakgrunnen er farge #6D7879. Teksten er noe mindre lesbar enn variant A.

## Referanser og videre diskusjon
WCAG 3 er enda under arbeid og det er svært mange diskusjoner som går inn på kontrast, det er også wiki-artikler fra aktive og inaktive arbeidsgrupper som kan være til hjelp for å belyse situasjonen
- Visual Contrast of Text Subgroup er en inaktiv gruppe som jobbet med kontrast og [foreslo blant annet at det å oppnå AAA-krav for kontrast fra WCAG 2.1 ville tilsvare nivå 3 i det som var den tidens nivåer diskutert for WCAG 3 (w3.org)](https://www.w3.org/WAI/GL/task-forces/silver/wiki/Visual_Contrast_of_Text_Subgroup#)
- Publisert utkast per august 2025, av [WCAG 3.0 inkluderer ikke enda kontrastreglenes utforming og heller ikke da APCA som kontrastmetode. (w3.org)](https://www.w3.org/TR/wcag-3.0/#maximum-text-contrast)
- Det er flere [tabeller foreslått brukt for oppfyllelse av ulike nivå i standarden (w3.org)](https://www.w3.org/WAI/GL/task-forces/silver/wiki/User:Myndex/Conformance), noen av dem foreslått av skaperen av APCA kan gi en forståelse av kompleksiteten.
- [Myndex Github repo for w3c WCAG 3 (github.com)](https://github.com/Myndex/apca-w3)
- I [WCAG 3 Github repoet er det rikelig med diskusjoner (github.com)](https://github.com/w3c/wcag3/issues?q=is%3Aissue%20state%3Aopen%20contrast%20label%3A%22Path%3A%20Visual%20appearance%22) om emnet, for eksempel en liste over [kilder som har gjort sine individuelle undersøkelser rundt APCA. (github.com)](https://github.com/w3c/wcag3/issues/29)
- Intervju med skaperen av APCA, hvor han går gjennom alt fra hvorfor metoden i WCAG 2 er problematisk og går også innom vitenskapen bak APCA med eksempler. [Video: How APCA Changes Accessible Contrast with Andrew Somers(youtube.com).](https://www.youtube.com/watch?v=E-CZial5VkU)
