...
Visual Contrast of Text Subgroup er en inaktiv gruppe som jobbet med kontrast og [foreslo blant annet at det å oppnå AAA-krav for kontrast fra WCAG 2.1 ville tilsvare nivå 3 i det som var den tidens nivåer diskutert for WCAG 3 | w3.org](https://www.w3.org/WAI/GL/task-forces/silver/wiki/Visual_Contrast_of_Text_Subgroup#)
  ...
  <li>
Publisert utkast per august 2025, av [WCAG 3.0 inkluderer ikke enda kontrastreglenes utforming og heller ikke da APCA som kontrastmetode.](https://www.w3.org/TR/wcag-3.0/#maximum-text-contrast)
  </li>
  <li>
Det er flere [tabeller foreslått brukt for oppfyllelse av ulike nivå i standarden](https://www.w3.org/WAI/GL/task-forces/silver/wiki/User:Myndex/Conformance), noen av dem foreslått av skaperen av APCA kan gi en forståelse av kompleksiteten.
  </li>
  <li>
[Myndex Github repo for w3c WCAG 3](https://github.com/Myndex/apca-w3)
  </li>
  <li>
I [WCAG 3 Github repoet er det rikelig med diskusjoner](https://github.com/w3c/wcag3/issues?q=is%3Aissue%20state%3Aopen%20contrast%20label%3A%22Path%3A%20Visual%20appearance%22) om emnet, for eksempel en liste over [kilder som har gjort sine individuelle undersøkelser rundt APCA.](https://github.com/w3c/wcag3/issues/29)
  </li>
</ul>
