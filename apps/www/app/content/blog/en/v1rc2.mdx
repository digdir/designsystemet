...
imageSrc: /img/blog/v1rc2/v1rc2.webp
imageAlt: Illustration of Design System V1 and question marks around it
imageCaption: Designsystemet needs some final adjustments before a full release of V1.
---
...
<Image
  src='/img/blog/v1rc2/v1-flyt.png'
  alt="Flow illustration of Designsystemet's products and tools."
  caption='Designsystemet today consists of several products, including Theme Builder, Design tokens, Figma library, CSS framework, React library, Theme package, and CLI (Command line tool). All these parts of the system should work seamlessly together and provide a coherent experience for users.'
  boxShadow={false}
