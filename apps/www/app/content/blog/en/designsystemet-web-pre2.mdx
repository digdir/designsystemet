...
The documentation will be continuously changed in the [README for the package](https://www.npmjs.com/package/@digdir/designsystemet-web?activeTab=readme), which you can read on NPM.
