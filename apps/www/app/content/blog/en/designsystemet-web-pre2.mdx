...
```html
<fieldset class="ds-toggle-group" focusgroup="radiogroup" aria-label="Text alignment">
  <label>
...
The documentation will be continuously changed in the [README for the package](https://www.npmjs.com/package/@digdir/designsystemet-web/v/0.0.0-fix-designsystemet-web-20260126133306), which you can read on NPM.
