...
We recommend using the migration plugin when following this guide. The migration can also be done manually, but it can be a significant amount of work, especially when cleaning up old component variants and instances.
...
**Do this:**
1. Run **Designsystemet migration helper**.
...
**Do this:**
1. Open **Designsystemet migration helper**.
2. Click **Update library**.
...
2. Run the **Designsystemet – Code syntax & scoping** plugin on the variables in the file.
