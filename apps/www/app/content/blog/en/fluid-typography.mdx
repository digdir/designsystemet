...
Based on [the disadvantages this caused](https://github.com/digdir/designsystemet/issues/1444), we chose to go with a [static typography scale](/en/fundamentals/designelements/typography#text-size) as the standard for Designsystemet.
