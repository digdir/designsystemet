...
imageAlt: The Norwegian Coastal Administration logo next to a screenshot from Styrbord showing component examples, a menu and settings.
...
<Image
  src='/img/blog/kystverket/kystverket-yggdrasil.webp'
  alt='Sunniva Unneland presenting Styrbord at the Yggdrasil conference, with a slide showing the colour palette on a large screen.'
  caption='Sunniva Unneland, designer from Bouvet, presents Styrbord at the Yggdrasil conference 2026.'
  boxShadow={true}
/>
