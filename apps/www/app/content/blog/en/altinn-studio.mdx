...
<Card data-color="brand2">
  ...
  uses Designsystemet. The article was first published on Medium.
</Card>
<br />
<br />
---
...
_Designsystemet has documentation on patterns for when the different variants should be used. [See for example the button at this link](/en/components/docs/button/overview)._
