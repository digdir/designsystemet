...
We are happy to announce the release of the `@digdir/designsystemet-web` package. This package now serves as a foundation for Designsystemet interactive components and helpers using native web technologies.
