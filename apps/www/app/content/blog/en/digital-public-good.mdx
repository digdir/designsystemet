...
We are proud to share that Designsystemet has officially been recognized as a *digital public good* by the Digital Public Goods Alliance (DPGA). This means that Designsystemet meets the [DPG standard](https://www.digitalpublicgoods.net/standard) and is available for use and reuse worldwide!
...
<Image
  ...
  boxShadow={false}
  caption='From Norway, Designsystemet is the fifth solution to be included in the DPG Registry. In total, there are now 215 approved Digital Public Goods (DPGs) worldwide.'
/>
