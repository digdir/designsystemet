---
title: First version of Designsystemet is ready!
description: Finally, V1 is here! After an extensive development process and close collaboration with several public entities, we are now launching the first stable version of Designsystemet!
date: 2025-03-03
...
At one point, we locked version 0.63, in connection with major changes that were to be made to the underlying token structure. After this, we've rolled out several "Release Candidates" for V1, and have now ended up with what becomes the first version of Designsystemet.
...
- Easier customization of Designsystemet's components to your own profile and preferences. --> [Set up your own theme](/en/fundamentals/start-here/own-theme).
...
The goal is for Designsystemet to be a good foundation that you can build upon, with your own profile, own preferences, and extended functionality as a layer on top.
...
Designsystemet is already in use by many, including [Altinn Studio](https://altinn.studio/), where 70 different agencies develop their services. If you use Altinn studio to develop services, you automatically use components from Designsystemet.

Several public organizations have also adopted Designsystemet in their own services.

<Card data-color='neutral'>
  <Details>
    <DetailsSummary>Examples of use</DetailsSummary>
    <DetailsContent>
    - [The Norwegian Food Safety Authority](https://www.mattilsynet.no/) builds its design system on top of Designsystemet.
- [The Norwegian Directorate for Education and Training](https://www.udir.no/) builds its design system on top of Designsystemet.
- [The Brønnøysund Register Centre](https://www.brreg.no/) has adopted Designsystemet on [Business Information](https://virksomhet.brreg.no/no/oppslag/enheter) and [Support Register](https://stotte.brreg.no/nb/oppslag/stoettetildeling), among others.
- [Data.norge.no](https://data.norge.no) uses tokens, components, and patterns from Designsystemet.
- [The Norwegian Customs](https://www.toll.no/) has adopted Designsystemet on their websites.
- [KS Digital](https://ksdigital.no) has adopted Designsystemet on [ledsagerbevis.no](https://ledsagerbevis.no/), among others.
- [The Norwegian Labour Inspection Authority](https://www.arbeidstilsynet.no/) has adopted Designsystemet on their websites.
- [Help page for shared solutions](https://eid.difi.no/nb) uses tokens and components from Designsystemet.
- [Digdir.no](https://www.digdir.no/), [UU-tilsynet](https://www.uutilsynet.no/), [UU-status](https://uustatus.no/), [the collaboration portal](https://samarbeid.digdir.no/) use tokens from Designsystemet.
...
Do you have input or would you like to contribute? [Send us an email](mailto:designsystem@digdir.no) or join the [community on Slack](https://designsystemet.no/slack). Please let us know if you have used or are considering using Designsystemet.

We look forward to seeing how Designsystemet can further streamline product development and help create more user-friendly digital solutions for everyone!
