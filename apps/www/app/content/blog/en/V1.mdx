...
- Easier customization of Designsystemet's components to your own profile and preferences. --> [Set up your own theme](/en/fundamentals/for-designers/custom-theme).
...
- [The Brønnøysund Register Centre](https://www.brreg.no/) has adopted Designsystemet on [Business Information](https://virksomhet.brreg.no/no/oppslag/enheter) and [Support Register](https://stotte.brreg.no/no/oppslag/stoettetildeling), among others.
...
- [Help page for shared solutions](https://eid.difi.no/no) uses tokens and components from Designsystemet.
