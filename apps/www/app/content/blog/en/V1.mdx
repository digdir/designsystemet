...
Do you have input or would you like to contribute? [Send us an email](mailto:designsystem@digdir.no) or join the [community on Slack](http://designsystemet.no/slack). Please let us know if you have used or are considering using Designsystemet.
