---
title: Web components and the Designsystem without React
description: Soon you can use the design system with both Svelte, Vue, Angular and all other technologies - also pure HTML and CSS. How will this be?
date: 2025-12-17
author: Designsystem
...
Many have asked if the Designsystem will offer web components so that you can use the components without React. The answer is yes!
But not everything will be web components. Let us explain why, and what we plan:

## Standards are good for everyone

Since the beginning, the goal has been to use web standards as much as possible, so that the Designsystem can be used in both old and new solutions,
...
The work to make the Design System available without React will start in January 2026.

We will continuously release experimental components in the `@digdir/designsystemet-native` (package name may change) package, so that you can quickly test and provide feedback.
