...
Although many associate Designsystemet with React components, it’s much more than that.  
For us at the Norwegian Food Safety Authority, the Figma library, CSS tokens, and documentation are invaluable resources.

**Curious to take a look under the hood of our solution?**  
<br />Visit [design.mattilsyn]()
