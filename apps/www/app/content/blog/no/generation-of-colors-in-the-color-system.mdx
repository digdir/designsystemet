...
description: Dette innlegget tek deg med på reisa me gjekk gjennom for å utvikle vår eigen tilnærming til fargegenerering, og korleis dette systemet fungerer i dag.
date: 2025-01-29
author: Designsystemet
imageSrc: /img/blog/generation-of-colors-in-the-color-system/fargepallet.png
imageAlt: Illustrasjon av farger
imageCaption: Illustrasjon av farger
search_terms: colors, color system, farger
---
...
Med dette så meiner me korleis lyset påverkar fargar i eit kontrollert miljø.
 ...
 <Image
  src='/img/blog/generation-of-colors-in-the-color-system/farger-lys.png'
...
Ulike kombinasjonar av desse tre verdiane gjev oss alle fargane me ser på skjermane våre. 
 ...
 <Image
  src='/img/blog/generation-of-colors-in-the-color-system/farge-rgb.png'
...
Shading er å leggje til svart i ein farge for å gjere den mørkare, medan tinting er å leggje til kvitt for å gjere den lysare.
 ...
 <Image
  src='/img/blog/generation-of-colors-in-the-color-system/rgb-digdir-red.png'
...
I døma vil me sjå på nokre av desse teknikkane og korleis dei fungerer.
 ...
 <Image
  src='/img/blog/generation-of-colors-in-the-color-system/fargar-hsl.png'
...
Endrar me på denne verdien vil fargane ofte ende opp med å sjå oversaturerte og ubalanserte ut.
 ...
 <Image
  src='/img/blog/generation-of-colors-in-the-color-system/fargar-hsl-2.png'
...
Etter å ha prøvd ut RGB og HSL fargeromma, var det på tide å sjå på dei andre fargeromma. 
 ...
 <Image
  src='/img/blog/generation-of-colors-in-the-color-system/fargerom-digdir-rod.png'
...
Denne verdien vert rekna ut basert på dei raude, grøne og blå komponentane i fargen, der grøn bidreg mest til den opplevde luminansen. 
 ...
 <Image
  src='/img/blog/generation-of-colors-in-the-color-system/fargar-contrast.png'
...
Begge gjer det enklare å lage fine og harmoniske fargar, men OKLCH er meir nøyaktig.
 ...
 <Image
  src='/img/blog/generation-of-colors-in-the-color-system/hsluv-farger.png'
...
I vårt tilfelle handla det om å trekke ei linje gjennom RGB-fargerommet.
 ...
 <Image
  src='/img/blog/generation-of-colors-in-the-color-system/interpolering.webp'
...
Å bevege seg iterativt gjennom eit fargerom på denne måten er ei form for interpolering.
 ...
 <Image
  src='/img/blog/generation-of-colors-in-the-color-system/rgb-interpolation.webp'
...
Dette var veldig nyttig, fordi då me då enkelt lage reglar på korleis fargane skulle brukast i systemet.
 ...
 <Image
  src='/img/blog/generation-of-colors-in-the-color-system/fargeskalaer-rgb.png'
...
Det er litt meir logikk som skjer her bak panseret, men det er ikkje avgjerande for å forstå korleis fargane blir genererte.
 ...
 <Image
  src='/img/blog/generation-of-colors-in-the-color-system/base-farger.png'
