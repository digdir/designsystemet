...
tilbyr `events` eller moderene [`command`-attributtar](https://developer.chrome.com/blog/command-and-commandfor) (med tilhøyrende [polyfill](https://github.com/keithamus/invokers-polyfill)) som vi kan nytte for å hjelpe med opning og lukking, og plassering.
