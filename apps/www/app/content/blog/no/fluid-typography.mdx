...
description: Det er mulig å bruke dynamiske tekst-størrelser uten breakpoints
date: 2024-04-26
author: Designsystemet
imageSrc: /img/blog/fluid-typography/fluid-front.png
...
search_terms: fluid, typography, tekststørrelse
---
...
<Image
  src='/img/blog/fluid-typography/fluid-ex.png'
...
Basert på [ulempene dette medførte](https://github.com/digdir/designsystemet/issues/1444), valgte vi å gå for en [statisk typografi-skala](/no/fundamentals/theme/typography#tekststørrelse) som standard for designsystemet.
...
<ResponsiveIframe
  src='/img/blog/fluid-typography/fluid-text-size.mp4'
