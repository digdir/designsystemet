...
Basert på [ulempene dette medførte](https://github.com/digdir/designsystemet/issues/1444), valgte vi å gå for en [statisk typografi-skala](/no/fundamentals/designelementer/typografi#tekststørrelse) som standard for designsystemet.
