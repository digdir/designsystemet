...
date: 2025-09-22
author: Avinor
imageSrc: /img/blog/avinor-post.png
...
– Vår nylanserte hjemmeside [avinor.no](http://avinor.no) har akkuratt tatt det i bruk, samt en flyplassassistent vi jobber med. For oss er digitale flater på lufthavnen en viktig del av helheten, og Designsystemet bidrar til å gjøre opplevelsen mer sømløs og gjenkjennbar for både ansatte og reisende, forteller Sverre.
 ...
 <Image
  src='/img/blog/avinor-nettsider.png'
  alt='Skjermbilde av Avinors nettsider'
  caption='Avinors nye nettsider (avinor.no)'
  boxShadow={true}
...
– Internt bruker vi det i en rekke løsninger. Vi har blant annet et system som gir oversikt over bagasje på lufthavnene og en værløsnig for brøytemannskaper. Vi har også en løsning som viser nåsituasjon av det som skjer for de som jobber operativt på alle de store lufthavnene. 
 ...
 <Image
  ...
  caption='Skjermbilder av Bag360 - Et system for oversikt over bagasjehåndtering på lufthavner'
  boxShadow={true}
...
/>
 ...
 <Image
  ...
  caption='Skjermbilder av Airport Operations Plan - Et verktøy for samhandling og oversikt på tvers av aktører på lufthavner'
  boxShadow={true}
