...
imageSrc: /img/blog/avinor/avinor-nettsider.png
...
– Vår nylanserte hjemmeside [avinor.no](http://avinor.no) har akkurat tatt det i bruk, samt en flyplassassistent vi jobber med. For oss er digitale flater på lufthavnen en viktig del av helheten, og Designsystemet bidrar til å gjøre opplevelsen mer sømløs og gjenkjennbar for både ansatte og reisende, forteller Sverre.
 ...
 <Image
  src='/img/blog/avinor/avinor-tromso-lufthavn.png'
...
– Internt bruker vi det i en rekke løsninger. Vi har blant annet et system som gir oversikt over bagasje på lufthavnene og en værløsnig for brøytemannskaper. Vi har også en løsning som viser nåsituasjon av det som skjer for de som jobber operativt på alle de store lufthavnene. 
 ...
 <Image
  src='/img/blog/avinor/avinor-bag360.png'
...
/>
 ...
 <Image
  src='/img/blog/avinor/avinor-op.png'
