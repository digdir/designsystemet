...
date: 2025-09-22
author: Avinor, Digdir
imageSrc: /img/blog/avinor/avinor-nettsider.webp
imageAlt: Avinors logo og skjermbilde av Avinors nettsider.
imageCaption: "På sine nye nettsider avinor.no har Avinor valgt å bygge på Designsystemet. De jobber også med en digital flyplassassistent. Med Designsystemet får både nettsider og skjermer på lufthavnene et mer sømløst og gjenkjennbart uttrykk."
search_terms: fagsystemer, interne, flyplass, touchskjermer, fagapplikasjoner, ekspertverktøy
---
...
– Vår nylanserte hjemmeside [avinor.no](http://avinor.no) har akkurat tatt det i bruk, samt en flyplassassistent vi jobber med. For oss er digitale flater på lufthavnen en viktig del av helheten, og Designsystemet bidrar til å gjøre opplevelsen mer sømløs og gjenkjennbar for både ansatte og reisende, forteller Sverre.

 <Image
  src='/img/blog/avinor/avinor-tromso-lufthavn.webp'
...
– Internt bruker vi det i en rekke løsninger. Vi har blant annet et system som gir oversikt over bagasje på lufthavnene og en værløsnig for brøytemannskaper. Vi har også en løsning som viser nåsituasjon av det som skjer for de som jobber operativt på alle de store lufthavnene. 
 ...
 <Image
  src='/img/blog/avinor/avinor-bag360.webp'
...
/>
 ...
 <Image
  src='/img/blog/avinor/avinor-op.webp'
...
De opplever også at Avinors visuelle profil og identitet kommer tydelig frem i løsningene. [Temabyggeren](https://theme.designsystemet.no/no) trekkes frem som et sentralt verktøy for å sikre at uttrykket er i tråd med selskapets identitet.
