...
description: En Release Candidate av V1 ble sluppet før sommeren. Etter det har vi fått flere verdifulle tilbakemeldinger fra våre brukere.
date: 2024-08-28
...
Om du har tilbakemeldinger er det kjempefint om du deler dette i [#Designsystemet-kanalen på Slack](https://designsystemet.no/slack), oppretter [issues i Github](https://github.com/digdir/designsystemet/issues/new/choose), eller sender oss en [epost](mailto:designsystem@digdir.no). 
