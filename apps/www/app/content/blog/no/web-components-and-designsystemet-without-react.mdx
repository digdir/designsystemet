...
Me vil fortløpande leggje ut eksperimentelle komponentar i pakken `@digdir/designsystemet-native` (pakkenavn kan endre seg), slik at du raskt kan teste og kome med tilbakemeldingar.
