...
Are you going to use the Design System with your own colors and branding? See the guide for [setting up the Design System with your own theme](/grunnleggende/for-designers/custom-theme).
...
Want to help create new components? [See how you can contribute](/grunnleggende/for-designers/contribute-in-figma).
...
The components support different brands and modes. To set up your own profiles, see the guide "[Design System with your own theme](/grunnleggende/for-designers/custom-theme)"
...
Read more about [color tokens](/grunnleggende/design-elements/colors) and what they are used for.

### Typography styles

For all text, you should use typography styles or typography components. This ensures that we have a consistent expression, correct use of spacing, sizes, and weights. Read more about [typography](/grunnleggende/design-elements/typography).
