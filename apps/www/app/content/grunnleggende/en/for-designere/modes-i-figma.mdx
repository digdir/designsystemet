...
In the theme builder, you can define colors and other visual settings for your design. See the guide [Use the Design System with your own theme](/grunnleggende/for-designers/custom-theme) to get started.
