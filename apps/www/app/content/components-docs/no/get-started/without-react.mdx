...
For å bruke Designsystemets CSS, så må du installere `@digdir/designsystemet-css`. Du kan også installere `@digdir/designsystemet-theme`, eller [lage ditt eget tema](/no/fundamentals/themebuilder/own-theme). Du kan lett lage ditt eget tema senere.
