...
We use [css layers](https://developer.mozilla.org/en-US/docs/Web/CSS/@layer) to get the lowest possible specificity on our css.
...
(with the Designsystemet design-tokens) or [Theme Builder](https://theme.designsystemet.no/).

If you are going to use this attribute, you must remember to define `font-family` to use the `--ds-font-family` CSS variable.
This can be solved by using [attribute selector](https://developer.mozilla.org/en-US/docs/Web/CSS/Attribute_selectors) in CSS, for example.
