...
**Note:** Prefer using [Tabs](/en/components/docs/tabs/overview) instead of `focusgroup="tablist"` in Designsystemet, as [Tabs](/en/components/docs/tabs/overview) already extends this pattern with tab activation, automatically connecting tabs to their panels etc.
