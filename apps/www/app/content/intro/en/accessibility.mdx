...
description: The Design System helps organizations comply with accessibility requirements through accessible components and guidance.
date: 2025-06-27
...
## What does the Design System solve, and what is your responsibility?
The Design System follows the WCAG requirements covered by accessibility regulations and helps make solutions as usable as possible for everyone. However, some responsibilities remain with the developers and designers implementing the components.
...
- **Specify the content language:** Use `<html lang="">`.
- **Enable dark mode:** Use `<body data-color-scheme="auto">`.
...
[In our GitHub Wiki you can find a detailed overview of which WCAG requirements the Design System helps you satisfy.](https://github.com/digdir/designsystemet/wiki/Designsystemet-hjelper-deg-%C3%A5-oppfylla-WCAG%E2%80%90kravane)
