...
The Design System can help with some of the WCAG requirements covered by accessibility regulations, but compliance also depends on how components are used, the content, and the rest of the solution.
