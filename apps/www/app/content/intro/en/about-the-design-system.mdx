...
description: Designsystemet provides core UI components and guidelines for coherent user experiences across services and organisations.
date: 2026-01-07
...
<Card data-color='brand3' variant="tinted">
    **Over 300 organisations in the community**

    Over 300 organisations and over 1,400 people are part of our community. Join us to learn, share, and help improve Designsystemet together. [Join the community](/en/intro/join-the-community)
</Card>
...
Designsystemet is integrated into 700 applications through [Altinn Studio](https://altinn.studio/), where 80 different agencies build digital services. If you’re building services in Altinn Studio, you’re already using components from Designsystemet.
...
<Card data-color='neutral'>
  <Details>
    ...
    <DetailsContent>
**Building their own design systems on top of Designsystemet:**
...
- Institute of Marine Research ([npmjs.com/@havforsk](https://www.npmjs.com/package/@havforsk/react-components))
- Helse Vest IKT ([Hviktor](https://github.com/HelseVestIKT/Hviktor))
- Innovation Norway ([koble.innovasjonnorge.no](https://koble.innovasjonnorge.no/?path=/docs/introduction-hva-er-koble--docs))
...
- Norwegian Coastal Administration ([Styrbord](https://kystverket.github.io/styrbord/base/?path=/docs/readme--docs))
- Landbruksdirektoratet
- Lånekassen ([lanekassen.github.io](https://lanekassen.github.io/designsystem/?path=/docs/introduksjon--docs))
- Lillestrøm municipality ([design.lillestrom.kommune.no](https://design.lillestrom.kommune.no/))
- Norwegian Food Safety Authority ([design.mattilsynet.no](https://design.mattilsynet.no/))
- The Norwegian Police IT Unit ([politiet.no/sherif](https://www.politiet.no/sheriff/?path=/docs/komponenter-popover--docs), uses some of Designsystemet's components as a starting point)
- Norwegian Red Cross ([norwegianredcross.github.io](https://norwegianredcross.github.io/DesignSystem/#design))
- Skagerak Energi ([npm.js](https://www.npmjs.com/package/@skagerakenergi/skagerak-design-components))
- Statkraft's design system in Figma.
- The National Audit Office of Norway
- UDI ([Smudi](https://smudi.udi.no/))
- The Norwegian Directorate for Education and Training ([design.udir.no](https://design.udir.no/))

<Divider style={{ margin: 'var(--ds-size-8) 0' }} />

**Using Designsystemet directly in solutions:**

<br />

- [Altinn](https://info.altinn.no/) uses Designsystemet.
...
- The Brønnøysund Register Centre uses Designsystemet in, among others, [brreg.no](https://www.brreg.no/), [Business information](https://virksomhet.brreg.no/nb/oppslag/enheter), and the [Grants register](https://stotte.brreg.no/nb/oppslag/stoettetildeling).
- [Data.norge.no](https://data.norge.no) uses Designsystemet.
- [Digitalt Dødsbo](https://info.altinn.no/skjemaoversikt/digitaliseringsdirektoratet/digitalt-dodsbo2/) uses Designsystemet.
- [Departementenes digitaliseringsorganisasjon](https://github.com/dss-web/dio-designsystemet) uses Designsystemet.
...
- [KI Norge](https://ki.norge.no/) uses Designsystemet.
- [NOBID ID](https://nobid.id/) uses Designsystemet.
- [Norge.no](https://norge.no) uses Designsystemet.
...
- [Offentlig fagdag](https://offentligfagdag.no/) is built using Designsystemet.
- [The County Governor](https://github.com/Statsforvalteren/designsystemet-staf) uses Designsystemet.
- Trøndelag County Municipality uses Designsystemet in some of its digital solutions.
- Vestfold county, student follow-up

<br/>

Do you know of another solution that uses Designsystemet? Add it to the list by [opening a pull request](https://github.com/digdir/designsystemet/pulls), or [send us an email](mailto:designsystem@digdir.no).
    </DetailsContent>
  </Details>
</Card>
