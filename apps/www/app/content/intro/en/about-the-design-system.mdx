...
description: Designsystemet is a shared toolkit of fundamental UI components, guidelines, and patterns that contribute to cohesive and recognisable user experiences across services.
date: 2026-01-07
...
Designsystemet is a collective public good through open source, and can be used by anyone to the extent they wish. It is developed to make it easier to create accessible, coherent, and user friendly digital services across organisations. It can be used together with an organisation’s own visual identity, allowing services to retain a unique expression.
...
<Card data-color='success' variant="tinted">
    **230 organisations in the network**

    In addition, more than 230 organisations (and 1,100+ people) are part of the Designsystemet community through Slack. [Join the Community!](/en/intro/join-the-community)
</Card>
