...
<Card data-color='neutral'>
  <Details>
    ...
    - [Byggforskserien](https://www.byggforsk.no/) builds its own design system on top of Designsystemet. 
    ...
    - [Norwegian Coastal Administration](https://kystverket.github.io/styrbord/base/?path=/docs/readme--docs) builds its own design system on top of Designsystemet.
    - Statkraft's design system in Figma is also built on Designsystemet. Future code will be developed from that.
    - Trøndelag County Municipality uses Designsystemet in some of its digital solutions.
    - The Norwegian Police IT Unit's design system [Sherif](https://www.politiet.no/sheriff/?path=/docs/komponenter-popover--docs) builds on some of the components from Designsystemet.
    ...
    - [Aibel](https://github.com/Aibel365/devops-designsystem) is building its own design system on top of Designsystemet.
    - [Norwegian Red Cross](https://norwegianredcross.github.io/DesignSystem/#design) is building its own design system on top of Designsystemet.
    - [BI](https://designsystem.bi.no) are using web elements from Designsystemet.
    - [Skagerak Energi](https://www.npmjs.com/package/@skagerakenergi/skagerak-design-components) is building its own design system on top of Designsystemet.
    ...
    - [UDI](https://www.udi.no/) is building its own design system on top of Designsystemet.
