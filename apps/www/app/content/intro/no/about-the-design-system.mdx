...
En annen fordel mange trekker frem når de tar i bruk Designsystemet, er at det er utviklet i Norge, for norske behov. Designsystemet forvaltes av et fast tverrfaglig team som jobber med det som en del av sitt ordinære arbeid, og som er lett å komme i kontakt med. Det betyr at løsningene tar utgangspunkt i norsk lovverk, norske krav til universell utforming og konteksten offentlig sektor opererer i. For mange gir dette trygghet og forutsigbarhet, og flere sier at de velger Designsystemet nettopp fordi det er norskutviklet.
