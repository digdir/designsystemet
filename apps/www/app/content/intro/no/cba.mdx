---
title: Designsystemet som fellesløsning
...
<Table>
  <TableHead>
    <TableRow>
      <TableHeaderCell scope="col">Gevinstområder</TableHeaderCell>
      <TableHeaderCell scope="col" style={{ textAlign: 'right' }}>Konsept 0</TableHeaderCell>
      <TableHeaderCell scope="col" style={{ textAlign: 'right' }}>Konsept 1</TableHeaderCell>
      <TableHeaderCell scope="col" style={{ textAlign: 'right' }}>Konsept 2</TableHeaderCell>
    </TableRow>
...
<Table border data-color="neutral">
  ...
  >
    <TableRow>
      <TableHeaderCell scope="col" data-color="neutral" style={{ backgroundColor: 'var(--ds-color-background-default)' }}/>
      <TableHeaderCell scope="colgroup" colSpan={3} style={{ textAlign: 'center' }}>
        Enhetsverdi
      </TableHeaderCell>
    </TableRow>
