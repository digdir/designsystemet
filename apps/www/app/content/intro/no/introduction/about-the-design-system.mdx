...
Designsystemet er etablert som et produkt i Digdir under produktgruppen [Portaler og brukeropplevelse](https://baksia.digdir.no/produktgrupper/portaler-og-brukeropplevelse/). Produktgruppen har et tilhørende produktråd med 13 ulike virksomheter.

Utviklingsteamet består av designere og utviklere fra Digdir, Brønnøysundregistrene, Mattilsynet, Utdanningsdirektoratet og KS Digital. I tillegg har vi et samarbeid med designsystem-teamene til Nav, Skatteetaten, Oslo kommune, Politiet og Entur om å etablere [felles interaksjonsmønstre](/no/patterns) på tvers. 

Designsystemet ønsker å legge til rette for et aktivt og inkluderende fellesskap der alle som ønsker kan bidra, dele erfaringer og lære av hverandre. Målet er å skape et miljø der både designere og utviklere kan diskutere utfordringer, dele løsninger og bidra til å forbedre Designsystemet. Du kan delta i fellesskapet gjennom [Slack](http://designsystemet.no/slack) og i [Github](https://github.com/digdir/designsystemet/discussions/categories/samarbeid-m%C3%B8nster-for-innbyggertjenester). Les mer om [samarbeidet](/no/fundamentals/introduction/collaboration). 
