...
If the user should be able to close the alert, it should be clear what happens next.
Instead of a general close icon, add one or more call to action buttons that both close the alert and provide the user's next step.

<Story story="ClosableEn" />
