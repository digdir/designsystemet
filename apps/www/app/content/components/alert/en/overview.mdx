...
- multiple error messages need to be summarised, use [`ErrorSummary`](/docs/komponenter-errorsummary--docs)
- the error prevents any further use of the service, use an error page instead
- the information is static and should always be visible, use [`Card`](/docs/komponenter-card--docs) instead
