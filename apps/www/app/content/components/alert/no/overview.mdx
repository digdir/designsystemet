...
Hvis brukeren skal kunne lukke alert, må det være tydelig hva som skjer videre.
I stedet for et generelt lukkekryss, avslutt heller alert med én eller flere knapper som både lukker den og gir brukeren neste steg.

<Story story="Closable" />
