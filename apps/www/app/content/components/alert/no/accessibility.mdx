...
**1. Dynamisk vist `Alert` skal leses opp**

En `Alert` som vises eller oppdateres etter at siden er lastet, skal annonseres automatisk av skjermlesere.
...
**2. `Alert` skal være plassert slik at leserekkefølgen gir mening**

- `Alert` skal være plassert i DOM på en måte som følger den logiske leserekkefølgen på siden.
- Hvis `Alert` inneholder en overskrift, skal den bruke riktig overskriftsnivå i sidestrukturen.

WCAG: [1.3.1](https://www.uutilsynet.no/wcag-standarden/131-informasjon-og-relasjoner-niva/90)

**3. Teksten skal være tydelig og konkret**

- `Alert` tekst skal tydelig beskrive hva meldingen gjelder og hva konsekvensen er.
