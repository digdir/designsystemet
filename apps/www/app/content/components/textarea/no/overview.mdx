...
**Unngå `Textarea` når**
- du forventer korte svar, bruk heller [`Textfield`](/no/components/textfield/overview)
...
I tillegg til disse retningslinjene, bør du også følge de generelle retninglinjene for [`Textfield`](/no/components/textfield/overview):
