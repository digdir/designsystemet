---
search_terms: trekkspill, utvid, sammenfelle, detaljer, detaljar, accordion, expand, collapse, expandable, reveal, hide, toggle
---
...
- du treng å dele opp innhaldet for å unngå for mykje informasjon på ein gong

**Unngå details når**
- du skal vise noke viktig som alle bør sjå
- du skal oppsummere feilmeldingar, bruk heller [error summary](/no/components/docs/error-summary/overview)
...
### Unngå details inni details
Det kan bli forvirrande for brukaren å forstå kva som er opna og lukka, spesielt når fleire nivå kan opnast samtidig.

### Unngå å lukke andre details når ein details blir opna
Det kan føre til at brukaren mistar innhald dei ønskjer å samanlikne eller kome tilbake til. Gjer berre dette når det er tydeleg for brukaren at berre éin details kan vere open om gongen, og denne åtferda er forventa.
