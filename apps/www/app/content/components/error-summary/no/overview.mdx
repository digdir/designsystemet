...
I noen tilfeller kan det likevel være bedre å vise oppsummeringen i toppen, det kan du lese mer om i [artikkelen om feilmeldinger](/no/patterns/errors).
...
- Hvis vi validerer fortløpende (for eksempel ved `onBlur` på hvert felt), venter vi med å vise error summary til brukeren prøver å sende inn skjemaet. 
