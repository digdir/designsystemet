...
Når brukeren har `prefers-reduced-motion` satt til `reduce` vil skeleton ha en animasjon på 1.6 sekunder. Animasjonen er ikke dekorativ, og vi skrur den derfor ikke av.
