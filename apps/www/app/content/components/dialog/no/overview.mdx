---
search_terms: modal, vindu, dialogvindu, bekreftelse, fokus, overlegg, overlay
---
...
### Ikke-modal dialog
Ikke-modale dialoger er nyttige når brukerne skal kunne fortsette å jobbe samtidig som vinduet er åpent. [NB: Sørg for at elementer som får fokus ikke skjules bak dialogen](/no/components/docs/dialog/accessibility#ikke-modale-dialoger). 
