...
- you want to provide short, optional information, use [`Popover`](/no/components/docs/popover/overview)  

See also the [system notifications pattern](/no/patterns/systemnotifications#når-bruker-vi-modaler) for more guidance on when a modal `Dialog` should be used.
...
[Note: Make sure that elements receiving focus are not hidden behind the dialog](accessibility#ikke-modale-dialoger).
