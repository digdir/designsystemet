...
- interrupting the user’s workflow may be problematic, use [`Alert`](/no/components/alert/overview), [`Popover`](/no/components/popover/overview) or a non-modal `Dialog` instead
