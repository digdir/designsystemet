...
- alternativa er svar i eit skjema – bruk heller [`Radio`](/no/components/radio/overview)  
- valet er ein av/på-innstilling – bruk heller [`Switch`](/no/components/switch/overview)  
