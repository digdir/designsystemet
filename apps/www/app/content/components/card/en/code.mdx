...
When `Card` finds an `<a>` inside the heading element, [data-clickdelegatefor](https://designsystemet.no/en/components/utilities/clickdelegatefor) will automatically be added to the card.
