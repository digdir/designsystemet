...
Bruk flere `Card.Block` hvis du vil dele opp kortet med skillelinjer eller legge til bilder eller video som går ut i kanten. 
Merk at når du bruker `Card.Block`, må alt innhold ligge inni `Card.Block` - ikke plasseres direkte i `Card`.
