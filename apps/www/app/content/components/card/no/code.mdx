...
Når `Card` finner en `<a>` inni heading-elementet vil [data-clickdelegatefor](https://designsystemet.no/no/components/utilities/clickdelegatefor) automatisk bli lagt til på kortet.
