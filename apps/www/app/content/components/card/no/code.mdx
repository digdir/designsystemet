...
Card har to css klasser, `ds-card` og `ds-card__block`, men alle css variabler er knyttet til hovedklassen `ds-card`.
...
Det er tre ulike måter å gjøre dette på.
