...
- det er viktige meldinger som bør presenteres som varsler (bruk heller [`Alert`](/no/components/alert))
...
Du kan dele kortet opp i seksjoner.
Disse får skillelinjer mellom seg, og kan inneholde bilder eller video som går ut i kanten.
...
Utvikler må passe på å bruke koret på rett måte på.
Dette er dokumentert i kodeeksemplene.
