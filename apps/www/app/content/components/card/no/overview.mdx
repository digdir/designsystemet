...
`Card` kan brukes som navigasjonskort for å ta brukerne videre til en annen side. Utvikler må passe på å bruke koret på rett måte på. Dette er dokumentert i kodeeksemplene.
