...
`Dropdown` lager ikke en semantisk meny, men legger grunnmuren for at du kan bygge din egen.
Les ["Menu and Menubar Pattern" på w3.org](https://www.w3.org/WAI/ARIA/apg/patterns/menubar/) for mer informasjon om hvordan du lager tilgjengelige menyer.
