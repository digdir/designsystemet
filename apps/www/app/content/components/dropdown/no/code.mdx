...
Dropdown er bygget på vår [popover-komponent](/no/components/docs/popover), og bruker [native popover-api (mozilla.org)](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Global_attributes/popover) i HTML.
