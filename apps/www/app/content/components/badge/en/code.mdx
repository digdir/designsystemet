...
Not all icons have the same shape, and then you may have to change where the badge should be placed. 
...
If you can't get the badge to be where you want it, you can the variables `--dsc-badge-top|right|bottom|left` to override the placement.
