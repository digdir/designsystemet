...
**Unngå `Input` når**
- du trenger et komplett skjemafelt med label, hjelpetekst og valideringsmelding, bruk heller [`Textfield`](/no/components/textfield/overview)
- feltet krever tilleggslogikk som allerede finnes i høyere komponenter som [`Textfield`](/no/components/textfield/overview)
...
Se retningslinjer for [`Textfield`](/no/components/textfield/overview).
