---
search_terms: formfield, textfield
---
...
**Avoid input when**
- you need a complete form field with label, description and validation message, use [textfield](/en/components/docs/textfield/overview) instead
- the field requires additional logic already provided by higher-level components such as [textfield](/en/components/docs/textfield/overview)

## Example

This component is used as a building block for other components, such as textfield. For that reason, this component will not have many examples or detailed guidance.
...
See the guidelines for [textfield](/en/components/docs/textfield/overview).
