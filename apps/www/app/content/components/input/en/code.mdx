...
To give you control over when the error state is displayed, we recommend instead showing and hiding an associated [Validation message](/en/components/docs/validation-message/overview) with the `hidden` attribute.
