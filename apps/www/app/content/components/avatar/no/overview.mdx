---
search_terms: avatar, profilbilde, profilbilete, profilfoto, brukeravatar, brukerikon, brukerbilde, brukerbilete, personikon, kontoikon, initiale, minibilde, medlemsbilde, profile picture, profile photo, profile image, user image, user picture, user photo, user icon, account icon, person icon, profile avatar
---
