...
Avatar viser som standard et brukerikon, men dette kan overstyres i CSS med variabelen `--dsc-avatar-icon-url`. Du kan og legge til et bilde eller ikon som innhold i avatar. Du må selv sette `aria-label` på avatar for å forklare hvem eller hva avataren representerer.
