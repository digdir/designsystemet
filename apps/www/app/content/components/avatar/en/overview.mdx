---
search_terms: picture, profile, photo, image, user, icon, account, person
---
...
### Variants
Avatar radius can be changed, but choose one consistent version throughout your solution.
