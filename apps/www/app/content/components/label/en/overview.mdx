...
When Label is used within [Radio](/no/components/docs/radio/overview) or [Checkbox](/no/components/docs/checkbox/overview), the font weight is automatically reduced. This creates a natural hierarchy between the Label and any legend text in the associated [Fieldset](/no/components/docs/fieldset/overview).
