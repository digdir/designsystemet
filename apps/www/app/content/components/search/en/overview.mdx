...
### Variants
The examples below show variants that include an icon, primary button and secondary button.
...
You should use a [label](/en/components/docs/label/overview) above the search field when it is not obvious what users are expected to search for, or when the search field is part of a form.

Read more about [labels, descriptions and placeholder text in forms](/en/best-practices/content-work/questions).
