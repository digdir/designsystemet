...
Du bør bruke [label](/no/components/docs/label/overview) over søkefeltet når det ikke er åpenbart hva brukeren skal søke etter, eller når søkefeltet er en del av et skjema.

Les mer om [ledetekster, beskrivelser og placeholder-tekst i skjema](/no/best-practices/content-work/questions).
