...
`FileUpload` skal alltid ha en synlig `Label` knyttet til seg via `Field`, slik at skjermlesere kan formidle hva som skal lastes opp. Bruk `FileUpload.Description` til å beskrive tillatte filformater og størrelser, slik at brukeren får denne informasjonen før opplasting.