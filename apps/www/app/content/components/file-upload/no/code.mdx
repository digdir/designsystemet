...
[react-dropzone](https://react-dropzone.js.org/) er et populært bibliotek for å lage filopplastingskomponenter i React. Her har du et eksempel på hvordan du kan bruke `react-dropzone` sammen med `FileUpload`.

<Story story="ReactDropZoneExample" defaultOpen language="react"/>
