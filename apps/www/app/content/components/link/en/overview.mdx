...
Instead, we always recommend using text to explain where the link leads. This makes the function clear both for users and for screen readers. Read more about this in the article [Labelling links](/en/patterns/external-links/#unngå-ekstern-lenke-ikon).
