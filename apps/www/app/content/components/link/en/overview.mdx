...
We do not recommend using an icon for external links. The icon can easily be misunderstood and lead to a poor user experience. Many interpret it as “opens in a new tab”, while others think it means “external site”.

Instead, we always recommend using text to explain where the link leads. This makes the function clear both for users and for screen readers. Read more about this in the article [Labelling links](https://www.designsystemet.no/no/patterns/external-links/#unngå-ekstern-lenke-ikon).
...
Read more about this in the article [Labelling links](https://www.designsystemet.no/en/patterns/external-links).
...
Find more guidance in the article [Labelling links](https://www.designsystemet.no/en/patterns/external-links#spr%C3%A5k).
