...
- the user should choose only one option; use a [`Select`](/en/components/docs/select/overview), [`Radio`](/en/components/docs/radio/overview) or a single [`Switch`](/en/components/docs/switch/overview) instead
