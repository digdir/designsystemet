...
### Outline
In some cases, it may be appropriate to emphasise options by using a larger click area around the checkbox. This can be useful, for example, when a simple list of standard checkboxes would result in a visually weak layout, or when the option represents a clear decision point that should stand out in the interface. It can also be used to group related information connected to the option, so that text, descriptions, and any additional details are perceived as a single, coherent interaction.
