...
It is displayed with a horizontal line when one or more checkboxes are selected in the group.
It will be displayed as a regular checkbox if all options in the group have the same state.
