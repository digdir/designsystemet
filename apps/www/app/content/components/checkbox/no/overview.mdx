...
- brukeren må velge mellom mer enn sju alternativer, bruk heller en [`Select`](/no/components/select/overview) eller [`Suggestion`](/no/components/docs/suggestion/overview)
