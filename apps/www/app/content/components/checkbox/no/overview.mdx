...
### Outline
I noen tilfeller kan det være hensiktsmessig å fremheve valgene med en større klikkflate rundt checkboxen. Dette kan for eksempel være når en enkel liste med standard checkboxer ville gitt en visuelt svak layout, eller når valget representerer et tydelig veivalg som bør skille seg ut i grensesnittet. Det kan også brukes for å gruppere mer informasjon som hører sammen med valget, slik at tekst, beskrivelser og eventuelle tilleggsdetaljer oppleves som én samlet og sammenhengende interaksjon.
