...
**Bruk `Checkbox` når**
- flere alternativer skal velges i skjemaer
- en brukrr skal akseptere vilkår og betingelser

**Unngå `Checkbox` når**
- det er kun ett alternativ, bruk heller [`Radio`](/no/components/radio/overview) eller en enkel [`Switch`](/no/components/switch/overview)
