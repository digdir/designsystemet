...
**Unngå `Checkbox` når**
- brukeren kun skal velge ett alternativ, bruk heller en [`Select`](/no/components/docs//select/overview), [`Radio`](/no/components/docs//radio/overview) eller en enkel [`Switch`](/no/components/docs//switch/overview)
- brukeren må velge mellom mer enn sju alternativer, bruk heller en [`Select`](/no/components/docs/select/overview) eller [`Suggestion`](/no/components/docs//suggestion/overview)
- noe skal slåes av eller på, bruk heller en [`Switch`](/no/components/docs//switch/overview)
