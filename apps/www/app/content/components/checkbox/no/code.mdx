...
Me bruker [`Fieldset`](/no/components/docs/fieldset/code), [`Label`](/no/components/docs/label/code) og [`Input`](/no/components/docs/input/code) for å lage ein `Checkbox`.
