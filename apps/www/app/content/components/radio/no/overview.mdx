...
### Forhåndsvalgt alternativ 
Et forhåndsvalgt alternativ kan gjøre et valg enklere, spesielt når de fleste velger det samme. Samtidig bør du vurdere ut fra konteksten hvordan du påvirker brukerens mulighet til å ta et bevisst valg eller om noen kan oppleve det som diskriminerende. 
...
## Tekst
En gruppe med flere alternativer bør alltid ha ledetekst (`<legend>`) og eventuelt en beskrivelse (`description`). Hvis en eller flere av radioknappene skal ha beskrivelse, skal den ligge rett under svaralternativet (`<label>`). 
