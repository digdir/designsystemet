---
search_terms: radioknapp, radiovalg, radiobutton, enkeltvalg, valg, alternativ, option
---
...
### Outline
Det finnes en variant av radio som heter `outline`. Den legger til ekstra padding og en ramme rundt valget, og øker dermed klikkområdet.
