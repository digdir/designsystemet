...
### Gruppering
Bruk [`Fieldset`](/no/components/docs/fieldset) rundt en gruppe med radioknapper for å gi en felles ledetekst(`<legend>`) og eventuelt en beskrivelse (`description`).

<Story story="Group" />

### Med feil
Her må vi bruke [`Fieldset`](/no/components/docs/fieldset), fordi den aktiverer riktig stil og sørger for at innholdet har de riktige sammenkoblingene for tilgjengelighet.
