...
### Med feil
Her må vi bruke [`Fieldset`](/no/components/fieldset), fordi den aktiverer riktig stil og sørger for at innholdet har de riktige sammenkoblingene for tilgjengelighet.
...
### Inline
Radio *kan* plasseres horisontalt med `flex`, men skal som hovedregel [plasseres vertikalt](/no/components/radio/overview#plassering).
<Story story="Inline" />
