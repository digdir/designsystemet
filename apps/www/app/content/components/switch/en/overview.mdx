...
- content should switch between two categories, use [`ToggleGroup`](/no/components/docs/togglegroup/overview) instead
- content should be filtered, use [`Chip`](/no/components/docs/chip/overview) instead
