...
- users are switching between different content views, such as list and graph, use [toggleGroup](/en/components/docs/toggle-group/overview) instead  
- content needs to be filtered, use [chip](/en/components/docs/chip/overview) instead  
