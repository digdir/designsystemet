...
Under brukar me `loading={true}` for å vise at knappen lastar noko. Her kan du også sende inn din eigen loading-komponent dersom vår [`Spinner`](/no/components/docs/spinner/code) ikkje passar.
