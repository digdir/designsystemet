...
WCAG: [2.4.4 Formål med lenke i kontekst (uutilsynet)](https://www.uutilsynet.no/veiledning/244-formal-med-lenke-i-kontekst/1251)
...
<span data-size="sm"> 
WCAG: [4.1.3 Statusbeskjeder (uutilsynet)](https://www.uutilsynet.no/veiledning/413-statusbeskjeder/1268)
</span>
