...
- ei handling skal utførast i tenesta

**Unngå `Button` når**
- det skal navigerast til andre sider eller ut av tenesta - bruk heller [`Link`](/docs/komponenter-link--docs)
- det skal filtrerast informasjon, for eksempel i lister eller tabeller - bruk heller [`Chip`](/docs/komponenter-chip--docs)
...
Lenker kan få utsjånad som ein knapp.
...
Den blir ofte brukt saman med ein primær- eller sekundærknapp, til mindre viktige handlingar. 
...
Ein aktiv knapp som viser ein feilmelding når brukaren klikkar, gjev i dei fleste tilfelle ein betre brukaroppleving. NAV har ei god forklaring på [kvifor deaktiverte tilstandar er problematiske (nav.no)](https://aksel.nav.no/god-praksis/artikler/deaktiverte-tilstander) og kva alternativ som finst.
