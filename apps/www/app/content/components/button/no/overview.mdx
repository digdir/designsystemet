...
#### Logg inn
Bruk knapp når «Logg inn» faktisk logger brukeren inn, for eksempel ved å sende inn et innloggingsskjema. Bruk [lenke](/no/components/docs/link/overview) når «Logg inn» sender brukeren til en innloggingsside eller ekstern innloggingstjeneste.
