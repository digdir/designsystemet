...
Suggestion is under development. If you find any issues or missing functionality, please report them on [Github](https://github.com/digdir/designsystemet/issues/new?template=1bug_report.yml) or in [Slack](https://designsystemet.no/slack).
</Alert>
...
- users need to choose between only a few options — use [`Radio`](/no/components/docs/radio/overview) or [`Checkbox`](/no/components/docs/checkbox/overview) instead  
