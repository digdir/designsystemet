...
**Note:** [Gov.uk](https://design-system.service.gov.uk/components/select) recommends avoiding `select` in public digital services. Their user research shows that people often find the component difficult to use correctly. It may be better to ask additional questions to reduce the number of options. If you ask the right questions first, radio buttons may be a better choice.
