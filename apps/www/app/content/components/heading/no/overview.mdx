...
`Heading` brukes til å skape struktur og hierarki i innholdet. Bruk overskrifter for å dele opp innholdet i logiske seksjoner. Pass på at du bruker [riktige overskriftsnivåer](/no/components/heading/accessibility#riktige-overskriftsnivåer) (h1-h6) for å sikre god semantisk struktur.
