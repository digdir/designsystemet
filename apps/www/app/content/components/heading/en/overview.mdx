...
`Heading` is used to establish structure and hierarchy in content. Use headings to divide information into clear, logical sections. Make sure to use [correct heading levels](/en/components/heading/accessibility#riktige-overskriftsnivåer) (h1–h6) to ensure proper semantic structure.
