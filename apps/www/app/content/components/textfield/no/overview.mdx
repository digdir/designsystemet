---
search_terms: tekstfelt, inputfelt, fritekst, input, singleline
---
...
Det er lovpålagt å markere påkrevde felt. Les om [obligatoriske og valgfrie felt](/no/patterns/required-and-optional-fields) for mer informasjon.

<Story story="Required" />

### Med teller
Du kan informere brukerne om hvor mange tegn de kan skrive inn.
...
Les mer om hvordan du skriver [ledetekster og spørsmål i skjema](/no/best-practices/content-work/questions).
