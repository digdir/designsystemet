...
<ds-field class="ds-field">
  ...
  <p class="ds-validation-message" data-field="counter" data-limit="20" data-over="%d characters too many" data-under="%d characters left" data-hint="Max %d characters allowed."></p>
</ds-field>
```
