...
* the explanation is longer than four words, use [`Popover`](/en/components/popover/overview) instead
* the content contains links or other interactive elements, use [`Popover`](/en/components/popover/overview) instead  
...
If richer content is needed – for example longer text, images, or buttons – use a [`Popover`](/no/components/popover/overview) instead.
