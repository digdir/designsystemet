...
* forklaringen er lengre enn fire ord, bruk heller [`Popover`](/no/components/popover/overview) 
* innholdet inneholder lenker eller andre interaktive elementer, bruk heller [`Popover`](/no/components/popover/overview)  
