...
Når en [validation message](/no/components/docs/validation-message/code) med `data-field="validation"` er et barn av `<fieldset>`, vil tilhørende `<ds-field>`-elementer 
automatisk bli oppdatert for å gjenspeile valideringsstatusen.
