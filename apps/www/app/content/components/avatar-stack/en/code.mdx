...
### Expandable
`data-expandable` animates overlap to 0 on hover or focus. Use `data-expandable="fixed"` to expand with overflow without changing the physical width. `tabindex="0"` is automatically added with `data-expandable`, but this can be overridden.
