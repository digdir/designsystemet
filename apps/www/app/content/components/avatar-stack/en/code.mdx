...
To create an avatar stack in plain HTML, use the `ds-avatar-stack` class on a `<div>`. Inside this, place elements with the `ds-avatar` class. Use `data-suffix` to add a text indicator for hidden avatars.
