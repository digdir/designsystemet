...
**Note:** In [browsers that do not support `sibling-index()`](https://caniuse.com/wf-sibling-count), `data-expandable` will not render correctly if it contains more than 12 avatars.
