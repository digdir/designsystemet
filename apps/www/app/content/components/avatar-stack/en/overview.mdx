...
AvatarStack is under development. If you find any errors or missing features, please report them on [Github](https://github.com/digdir/designsystemet/issues/new?template=1bug_report.yml) or in [Slack](https://designsystemet.no/slack).
</Alert>
