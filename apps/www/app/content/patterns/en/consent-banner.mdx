...
If the website only uses strictly necessary technologies — for example storing language preferences or login status — you do not need to show a consent banner. However, you should still inform users that these technologies are being used.
