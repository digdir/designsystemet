...
partners: Digdir, Nav, The Norwegian Tax Administration, The Brønnøysund Register Centre, City of Oslo, Norwegian Police Service, Entur
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      <TableCell>
        [68 05 99 99](tel:68059999) (Lacks purpose)
      </TableCell>
      <TableCell>
        [Call us at 68 05 99 99](tel:68059999)
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
    ...
    <TableRow>
      <TableCell>
        [Edit](https://github.com/digdir/designsystemet/blob/main/apps/www/app/content/patterns/en/external-links.mdx) (Says nothing about what or where)
      </TableCell>
      <TableCell>
        [Edit this page on github.com](https://github.com/digdir/designsystemet/blob/main/apps/www/app/content/patterns/en/external-links.mdx)
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
...
<Image
  src="/img/patterns/external-links/lenkeliste1.png"
...
<Image
  src="/img/patterns/external-links/lenkeliste2.png"
...
<Image
  src="/img/patterns/external-links/lenkeliste3.png"
...
<Image
  src="/img/patterns/external-links/externallinks-icon.png"
...
### Destination
It's not always necessary to explicitly label a link as external. Often this is clear from the context. For example, if the link text is “Flekkefjord municipality,” users will naturally expect it to lead to the municipality’s website. In such cases, extra labeling is unnecessary.

If the link points to specific content on the municipality’s site, such as parking information, the link can be "Parking in Flekkefjord municipality" or "Parking (flekkefjord.kommune.no)." The most important thing is that the user is not surprised by where the link takes them.
...
<Image
  src="/img/patterns/external-links/nedlasting-lenker.png"
...
<Card
  ...
  data-unstyled
>
  Note: We want to further explore how we should communicate the downloading of files or external documents, since we can't guarantee how the browser will handle it. There is an ongoing discussion about this on GitHub: [Can we actually know if a file will open in a new tab?](https://github.com/digdir/designsystemet/discussions/3587)
</Card>
...
You can contribute to the work in the [GitHub discussion thread about links](https://github.com/digdir/designsystemet/discussions/2294) or in the [#Mønster channel](https://designsystemet.slack.com/archives/C05RBGB92MC/p1712751837722749) on [Slack](https://designsystemet.no/slack).
...
<Contributors
  authors={[
    'Sarah Brodwall (Nav)',
    'Eivind Løland-Andersen (The Norwegian Tax Administration)',
    'Trond Ausland (The Norwegian Tax Administration)',
    'Jan Schjetne (City of Oslo)',
    'Stine Rørvik (City of Oslo)',
    'Roy Halvor Frimanslund (The Brønnøysund Register Centre)',
    'Linn Kamilla Drågen (The Brønnøysund Register Centre)',
    'Øyvind Hjartnes (Entur)',
    'Chris Lorang (Norwegian Police Service)',
