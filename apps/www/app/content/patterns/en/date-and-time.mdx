...
partners: Digdir, The Brønnøysund Register Centre
date: 2026-03-05
order: 10
---
...
<Card
  ...
  variant="tinted"
>
This article has been developed by the design system team at The Norwegian Digitalisation Agency in collaboration with Brønnøysundregistrene. It has *not* gone through the same collaborative process as the patterns in the [Pattern collaboration](/en/intro/collaboration#3-cross-agency-pattern-collaboration). We would like feedback on the article. Please share it in [Slack](https://designsystemet.no/slack) or in this [discussion thread on github.com](https://github.com/digdir/designsystemet/discussions/1681).
...
<Contributors
  authors={[
    ...
    'Ole Martin Tangen Vad (The Brønnøysund Register Centre)',
