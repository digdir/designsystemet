...
<Image
  ...
  alt="Illustrasjonen viser en grensesnitt med tittelen 'Hvem vil du bruke tjensten på vegne av?' og noen valg mellom personer og virksomheter. Det er også en beskrivelse som forklarer hvorfor brukerne kan gjøre noe på vegne av noen andre, for eksempel at de er foresatt, har fått fullmakt eller er daglig leder."
  style={{ maxWidth: '700px' }}
  boxShadow={false}
...
<Image
  ...
  alt="Illustrasjonen viser en grensesnitt med tittelen ..."
  style={{ maxWidth: '700px' }}
  boxShadow={false}
