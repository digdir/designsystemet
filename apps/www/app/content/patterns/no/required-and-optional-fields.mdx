...
Hvis vi kan holde oss til ett spørsmål per side, så er det det aller enkleste for brukeren. Gjør vi det, trenger vi ikke å markere hvilke felt som må fylles ut, men vi kan gjøre det tydelig i ledeteksten eller hjelpeteksten om det er obligatorisk eller valgfritt. 

<Image
  src='/img/obligatorisk-eks1.png'
  alt='Skjermbilde av skjema med ett spørsmål på en side, der brukeren får spørsmålet "Hva er fødselsnummeret til personen du skal gifte deg med?" og en hjelpetekst som sier "Har personen D-nummer bruker du det." Videre følger et inputfelt for fødsselsnummer.'
  boxShadow={false}
/>
