...
1. [Ett tema per side](#1-ett-tema-per-side)
...
Det er enklest for brukeren når én side handler om ett tydelig tema eller én oppgave. I slike tilfeller trenger vi ikke å markere hvert enkelt felt som obligatorisk, så lenge det er tydelig at brukeren forventes å svare på det som vises på siden.

Et «tema» kan bestå av ett eller flere felter som naturlig hører sammen. Hvis du for eksempel ber brukeren om adresse, vil det ofte være flere felter (gateadresse, postnummer, poststed), men fortsatt ett samlet spørsmål eller én oppgave.

I disse tilfellene kan det være tilstrekkelig å gjøre det tydelig i ledeteksten eller hjelpeteksten at informasjonen må fylles ut.
