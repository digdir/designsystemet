...
<Image
  ...
  alt='Skjermbilde av skjema med ett spørsmål per side, der brukeren får spørsmålet "Hva er fødselsnummeret til personen du skal gifte deg med?" og en hjelpetekst som sier "Har personen D-nummer bruker du det." Videre følger et inputfelt for fødsselsnummer.'
  boxShadow={false}
/>
