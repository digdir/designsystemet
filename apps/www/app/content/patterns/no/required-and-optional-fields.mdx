...
Det er enklest for brukeren hvis det bare er ett spørsmål per side. Gjør vi det, trenger vi ikke å markere hvilke felt som må fylles ut, men vi kan gjøre det tydelig i ledeteksten eller hjelpeteksten om det er obligatorisk eller valgfritt. 
