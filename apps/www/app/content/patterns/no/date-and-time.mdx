...
<Image
  src='/img/date-and-time/example10.webp'
  alt='Forhåndsdefinert utvalg datoer eksempel 4'
  boxShadow={false}
/>

Alternativ løsning med radioknapper, kan noen ganger være bedre slik at brukeren ser alle ledige tidspunkt med en gang uke eller dag er valgt.
