...
#### Reverse tabnabbing
Når du åpner en lenke i en ny fane med `target="_blank"`, kan nettsiden du lenker til få tilgang til vinduet du kommer fra og i verste fall bytte det ut med noe ondsinnet. Dette kalles reverse tabnabbing.

Moderne nettlesere hindrer vanligvis dette automatisk. Likevel kan det være lurt å legge til `rel="noreferrer"` som ekstra sikkerhet, særlig for brukere med eldre nettlesere. Da hindrer du at den nye fanen får kontroll over den gamle.
