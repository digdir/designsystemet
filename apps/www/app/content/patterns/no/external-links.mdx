...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      <TableCell>
        [Rediger](https://github.com/digdir/designsystemet/blob/main/apps/www/app/content/patterns/no/external-links.mdx) (sier ingenting om hva som redigeres eller hvor)
      </TableCell>
      <TableCell>
       [Rediger denne siden på github.com](https://github.com/digdir/designsystemet/blob/main/apps/www/app/content/patterns/no/external-links.mdx)
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
...
Dersom lenken viser til et spesifikt innhold hos kommunen, som for eksempel informasjon om parkering, kan lenken være "[Parkering i Flekkefjord kommune](https://flekkefjord.kommune.no/tjenester/vei-vann-og-renovasjon/parkering/parkeringsplasser-og-priser/)" eller "[Parkering (flekkefjord.kommune.no)](https://flekkefjord.kommune.no/tjenester/vei-vann-og-renovasjon/parkering/parkeringsplasser-og-priser/)" Det viktigste er at brukeren ikke blir overrasket over hvor de havner etter å ha klikket.
