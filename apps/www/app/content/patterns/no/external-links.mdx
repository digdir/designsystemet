...
Dersom lenken fører til en fil som skal lastes ned istedenfor å åpnes i nettleseren, bør man sørge for å ha med attributten `download` med filnavn som indikerer filtype, f.eks. `download="årsrapport.docx"`. 
