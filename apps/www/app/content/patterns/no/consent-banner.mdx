...
search_terms: consent banner, cookie banner, cookies, samtykke, personvern, gdpr
date: 2026-06-29
order: 75
---
...
Samtidig er de juridiske rammene klare. Samtykket må fylle kravene til et gyldig samtykke etter personvernforordningen og løsningen for å hente inn samtykke må følge kravene i Forskrift om universell utforming av IKT-løsninger.
...
Datatilsynet og Nkom deler tilsynsansvaret for reglene om lagring av og tilgang til informasjon på brukernes enheter i [ekomloven § 3-15 (lovdata.no)](https://lovdata.no/lov/2024-12-13-76/%C2%A73-15). Datatilsynet fører tilsyn med kravene til samtykke og informasjon. Du finner veiledning om dette i [Datatilsynets veileder om informasjonskapsler og andre sporingsteknologier (datatilsynet.no)](https://www.datatilsynet.no/personvern-pa-ulike-omrader/internett-og-apper/bruk-av-informasjonskapsler-og-andre-sporingsteknologier/). Nkom vurderer blant annet hvilke teknologiske løsninger som omfattes av bestemmelsen og når unntakene kan brukes. Du finner mer informasjon på [Nkoms side om informasjonskapsler (nkom.no)](https://nkom.no/internett/informasjonskapsler-cookies). I arbeidet med dette mønsteret har vi hatt dialog med begge tilsynsmyndighetene og fått veiledning underveis.
...
### Lagring av samtykke
Du trenger ikke innhente et eget samtykke for å lagre selve samtykkesvaret. Dette er en strengt nødvendig opplysning, siden du er pålagt å be om samtykke og det er nødvendig å lagre svaret for å oppfylle dette.
...
<Image
  src="/img/patterns/consent-banner/consent-banner-simple.png"
  boxShadow={false}
  ...
  caption='Et enkelt samtykkebanner med ett spørsmål og to likeverdige valg. I dette eksempelet samler vi kun informasjon om hvordan nettsiden brukes. Brukerne må forstå hva som skjer når de svarer ja, så tilpass teksten din til hvilke opplysninger som samles inn og hva de brukes til. '
/>
...
Bruk [avkrysningsbokser](/no/components/docs/checkbox/overview), ikke brytere. En bryter ([switch](/no/components/docs/switch/overview)) signaliserer at endringen trer i kraft umiddelbart. Det passer ikke her, siden valget først gjelder etter at brukerne har bekreftet. Avkrysningsbokser forteller brukerne at dette er noe de selv stiller inn og deretter lagrer. Ingen av avkrysningsboksene skal være forhåndsmarkert.
...
<Image
  src="/img/patterns/consent-banner/consent-banner-check.png"
  boxShadow={false}
...
Om nettstedet ditt kun bruker strengt nødvendige teknologier, trenger du ikke vise et samtykkebanner. Informer likevel om at du bruker slike. 

<Image
  src="/img/patterns/consent-banner/consent-banner-footer.png"
  boxShadow={false}
  ...
  caption='Hvis nettstedet kun bruker strengt nødvendige teknologier, som for eksempel informasjonskapsler i dette tilfellet, holder det å informere om dette i bunnen av nettsiden, uten å be om samtykke.'
/>
...
<Image
  src="/img/patterns/consent-banner/consent-banner-video.webp"
  boxShadow={false}
...
[Ikke-modal dialog](/no/components/docs/dialog/overview#ikke-modal-dialog) bør unngås fordi den legger seg over annet interaktivt innhold på siden. Dette bryter [WCAG 2.4.11 Fokus ikke skjult (minimum)](https://www.w3.org/WAI/WCAG22/Understanding/focus-not-obscured-minimum.html). Suksesskriteriet ble innført i WCAG 2.2 og er foreløpig ikke en del av tilgjengelighetsforskriften, men representerer likevel god praksis for tilgjengelighet. Se også [2.4.7 Synlig fokus (uutilsynet)](https://www.uutilsynet.no/wcag-standarden/247-synlig-fokus-niva-aa/109), som er en del av dagens tilgjengelighetskrav.
...
<Image
  src="/img/patterns/consent-banner/consent-banner-footerchange.png"
  boxShadow={false}
...
Strengt nødvendige teknologier skal ikke være en del av spørsmålet brukerne skal ta stilling til, så de bør du ikke nevne i knappene.
  </DoDont>
  <DoDont story="DoButtons2">
Bruk knappetekster som svarer på spørsmålet i samtykkebanneret, og hold informasjonen om strengt nødvendige teknologier adskilt fra valgalternativene. 
  </DoDont>
</div>

<div className="dodont-row">
  <DoDont story="DontNecessaryCookiesCheckbox">
Ikke vis strengt nødvendige teknologier som et forhåndsvalgt eller deaktivert valg. De kan ikke velges bort, og skal derfor heller forklares i tekst.
  </DoDont>
  <DoDont story="DoNecessaryCookiesCheckbox">
Legg informasjonen om strengt nødvendige teknologier *under* valgalternativene, siden det ikke er en del av spørsmålet brukerne skal ta stilling til. 
  </DoDont>
</div>
...
### Knapper og lenker
Funksjonene for å godta eller avslå skal kodes som knapper (`<button>`), siden de utfører handlinger. Innganger til personvernerklæringen eller mer informasjon om informasjonskapsler koder du ut fra hva som skjer når brukerne aktiverer dem:
