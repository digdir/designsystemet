...
Feilmeldinger kan komme fra systemet eller være utløst av noe brukerne har gjort. Denne artikkelen handler om brukerutløste feilmeldinger i selvbetjeningsløsninger og skjema. Du finner informasjon om systemvarsler i [artikkelen om systemvarsler](/no/patterns/systemnotifications). 
...
<Image
  src='/img/patterns/errors/errormessage-co-1.webp'
...
<Image
  src='/img/patterns/errors/errormessage-co-3.webp'
  alt='Skjermbilde av skjema med en feilmelding. Brukeren har skrevet "fdgdfgfdg" inn i et felt for fødselsnummer. Feilmeldingen sier at Fødselsnummer  skal inneholde 11 siffer.'
  boxShadow={false}
/>
...
Vi bruker systemmeldinger, eller systemvarsler, for å varsle brukeren om feil i systemet eller gi dem viktig informasjon de bør få med seg. Vi har en [egen artikkel om systemvarsler](/no/patterns/systemnotifications).
...
<Image
  src='/img/patterns/errors/errormessage-design.png'
...
>
  ...
  <DetailsContent
    ...
    >
      <source
        src='/img/patterns/errors/error-message-group-error.mp4'
        type='video/mp4'
      />
    </video>
    ...
    <Image
      src='/img/patterns/errors/errormessage-co-22b.webp'
...
<Card data-color='brand3' variant="tinted">
  Vi unngår inntil videre å bruke `aria-errormessage` da den ikke har full støtte av hjelpemidler per nå. Men vi kommer til å oppdatere retningslinjene om støtten blir bedre i fremtiden. [Se diskusjon på github](https://github.com/digdir/designsystemet/discussions/1684)
</Card>
...
<Card data-color='brand3' variant="tinted">
  Retningslinjene er utarbeidet i en tverretatlig arbeidsgruppe med deltakere fra Digdir, Nav, Skatt, Brreg, Politiet, KS og Oslo kommune. Du kan påvirke arbeidet i [diskusjonstråden om systemvarsler på Github](https://github.com/digdir/designsystemet/discussions/1684) eller i [Slack](https://designsystemet.no/slack).
</Card>
