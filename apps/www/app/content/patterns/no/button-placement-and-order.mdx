...
<Image
  src="/img/patterns/button-placement-and-order/button-order.png"
...
<Image
  src="/img/patterns/button-placement-and-order/button-left.png"
...
/>
<Image
  src="/img/patterns/button-placement-and-order/button-right.png"
...
<Image
  src="/img/patterns/button-placement-and-order/button-modal.png"
...
<Image
  src="/img/patterns/button-placement-and-order/button-popover.png"
...
<Image
  src="/img/patterns/button-placement-and-order/button-form-onepage.png"
  alt="Skjema med et utfyllingsfelt og en primærknapp med teksten 'Send inn', ettefulgt av en sekundærknapp med teksten 'Avbryt'."
  boxShadow={false}
...
<Image
  src="/img/patterns/button-placement-and-order/button-form-firstpage.png"
  alt="Skjema med flere sider, der første side har en primærknapp med teksten 'Neste steg' og ingen sekundærknapp."
  boxShadow={false}
...
>
**Mer innsikt kreves** \
Har du innsikt om plassering av Neste/Forrige-knapper, del gjerne i pågående [diskusjon på Github](https://github.com/digdir/designsystemet/discussions/1671).
</Card>

<Image
  src="/img/patterns/button-placement-and-order/button-form-secondpage.png"
  alt="Side 2 i et skjema som har en primærknapp med teksten 'Neste steg' og en sekundærknapp med teksten 'Forrige steg'. Neste steg ligger først på desktop."
  boxShadow={false}
...
<Image
  src="/img/patterns/button-placement-and-order/button-form-secondpage-alt2.png"
  alt="Side 2 i et skjema som har en primærknapp med teksten 'Neste steg' og en sekundærknapp med teksten 'Forrige steg'. Forrige steg ligger først på desktop."
  boxShadow={false}
...
<Image
  src="/img/patterns/button-placement-and-order/button-form-lastpage.png"
  alt="Siste steg i et skjema som har en primærknapp med teksten 'Send inn' og en sekundærknapp med teksten 'Forrige steg'."
  boxShadow={false}
...
<Image
  src="/img/patterns/button-placement-and-order/button-language-bad.png"
  alt="Unngå: En modal som viser 'Er du sikker på at du vil avbryte?' Og så to knapper med teksten 'Ok' og 'Avbryt'."
  boxShadow={false}
...
<Image
  src="/img/patterns/button-placement-and-order/button-language-good.png"
  alt="Gjør: En modal som viser 'Er du sikker på at du vil avslutte uten å lagre?' Og så to knapper med teksten 'Avslutt uten å lagre' og 'Fortsett redigering'."
  boxShadow={false}
