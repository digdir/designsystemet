...
>
**Mer innsikt kreves** \
Vi ønsker å gjennomføre en brukertest for å lande på et valg for plassering av Neste/Forrige. Vi deler innsikten når vi vet mer. Har du innsikt om dette, del gjerne i pågående [diskusjon på Github](https://github.com/digdir/designsystemet/discussions/1684#discussioncomment-9339006).
</Card>
...
<Image
  ...
  boxShadow={true}
  dataUnstyled
  caption='Eksempelet over viser siste steg i et skjema, der det er "Forrige"-knapp og "Send inn"-knapp.'
/>
