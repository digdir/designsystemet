...
Me opplevde derfor mange av dei samme utfordringane med desse fargeromme som med HSL, der me måtte skrive mykje komplisert logikk for å få fargar med ulike fargetonar til å fungere godt i saman.
...
Etter å ha sett mykje på korleis dei ulike fargeromma fungerte og produserte fargar på, 
var det på tide å sjå på korleis desse kunne kombinerast med å lage eit system for kontrastar og tilgjengeligheit.


## WCAG og offentlege nettsider

WCAG (Web Content Accessibility Guidelines) er retningslinjer utvikla av World Wide Web Consortium (W3C) for å sikre at nettsider og digitalt innhold er tilgjengelege for alle. 
Det fins tre samsvarsnivå: A, AA og AAA, kor AA er den mest brukte standarden for tilgjengelighet.
Per 2024 seier regelverket at offentlege nettsider må oppfylle alle AA-krava i WCAG. 

Vår tilnærming til utvkinga av fargesystemet er at alt me gjer skal følge alle AA-krava, 
og at me prøver å strekke oss til AAA-nivået der det gir meining og ikkje påverkar designet i for stor og negativ grad.
