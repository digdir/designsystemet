...
Shading er når ein legg til svart i ein farge for å gjere den mørkare, medan tinting er når ein legg til kvitt for å gjere den lysare.
 ...
 <Image
  ...
  alt='Illustrasjon av HSLuv1.'
  caption='Viser fargeskala for Digdir sin raude profilfarge i RGB-fargerommet.'
  boxShadow={false}
  dataUnstyled
/>
...
I eksempla nedover vil me sjå på nokre av desse teknikkane og korleis dei fungerer.
 ...
 <Image
  ...
  alt='Illustrasjon av HSLuv1.'
  caption='Viser fargeskala for Digdir sin raude profilfarge i HSL-fargerommet.'
  boxShadow={false}
  dataUnstyled
/>
...
Endrar me kun på denne så endar fargane veldig ofte opp med å sjå oversaturerte og obalanserte ut.
 ...
 <Image
  ...
  alt='Illustrasjon av HSLuv1.'
  caption='Viser fargeskala for Digdir sin raude profilfarge i HSL-fargerommet med fast saturation (fargemetning).'
  boxShadow={false}
  dataUnstyled
/>
...
Det var viktig for oss at denne fargen fortsatt blei med fordi det ofte kan vere ein viktig farge for brukaren.
...
Me var ute etter å finne ein metode for å lage fargeskalaene på som var enkel å jobbe med og som produserte fine og balanserte fargar.

 <Image
  src='/img/bloggen/fargerom-digdir-rod.png'
  alt='Illustrasjon av HSLuv1.'
  caption='Viser fargeskalaer for Digdir sin raude profilfarge i ulike fargerom.'
  boxShadow={false}
  dataUnstyled
/>
...
Me opplevde derfor mange av dei samme utfordringane med desse fargeromma som med HSL, der me måtte skrive mykje komplisert logikk for å få fargar med ulike fargetonar til å fungere godt i saman.

OKLCH og LAB fungerte relativt bra, 
...
produserte riktige og balanserte fargar for det menneskelege auget.

Etter å ha studert korleis dei ulike fargeromma fungerer og produserer fargar, var tida komen til å undersøkje korleis desse kunne kombinerast for å utvikle eit system for kontrastar og tilgjengelegheit.
...
Samtidig strekke me oss mot AAA-nivået der det er meiningsfullt  og ikkje går på bekostning av designet.
...
medan om fargane ikkje har kontrast i det heile tatt, er poengsummen `1:1`. 
 ...
 <Image
  ...
  alt='Illustrasjon av HSLuv1.'
  caption='Illustrasjon som viser kontrast og relativ luminans mellom 3 bakgrunnar og ein svart tekstfarge.'
  boxShadow={false}
  dataUnstyled
/>

Luminansen skildrar den opplevde lysstyrken til ei flate og blir brukt til å vurdere kor mykje lys som blir reflektert
...
I bildet over vises kontrasten mellom 3 raude bakgrunnar og ein svart tekstfarge. 
Den lysaste bakgrunnen har ein kontrast på `10:1`, medan den mørkaste bakgrunnen har ein kontrast på `2.8:1`. 
Dei 3 bakgrunnsfargane har og ein relativ luminans frå `0.5` til `0.1`. 
Den mørkaste bakgrunnen begynnar å nærme seg svart, og får derfor ein relativ luminanse på `0.1`.
Me vil kome litt tilbake til luminans når me skal begynne å generere fargar basert på kontrast litt seinare.




## Fargerom basert på kontrast
Som me har vore inne på litt tidligare så fins det mange fargerom som har ein lightness-verdi i seg som definerer kor lys ein farge er. 
For enkelte fargerom så betyr denne lightness-verdien at kontrasten mellom fargane alltid blir like. 
For å vise og forklare dette så har me valgt ut to fargeom som gjer dette, HSLUV og OKLCH.
