...
Med dette som utganspunkt var det på tide å sjå på korleis me kunne gjere det i praksis.
...
Å sette ned saturation-verdien på alle fargane hjelper, men problemet no er at me mister den opphavlege fargen som blei brukt for å generere fargeskalaen. 
...
Me ønskte å finne ein metode for å lage fargeskalaer som var enkel å bruke og som gav fine og balanserte fargar

 <Image
  src='/img/bloggen/fargerom-digdir-rod.png'
  alt='Illustrasjon av HSLuv1.'
  caption='Viser fargeskalaer med utgangspunkt i Digdir sin raude profilfarge i ulike fargerom.'
  boxShadow={false}
  dataUnstyled
/>
...
Då alt dette var sagt og gjort, var tida komen for å undersøkje korleis me kunne lage fargeskalaer basert på kontrast og tilgjengeligheit.
...
Samtidig ønska me å strekke mot AAA-nivået der det var meiningsfullt og ikkje gjekk på bekostning av designet.
...
Me vil kome meir tilbake til luminans når me skal snakke om korleis me endte opp med å generere fargane.
...
Fargen som blir brukt for å generere ein skala får navnet `Base Default`.
...
Me opplevde at luminans fungerte dårlig som utgangspunkt for og seie at ein farge skulle bli 8% lysare eller mørkare. 
...
Då har me vore innom mykje spennande og interessant (vår meining) innan fargar og fargegenerering.
Godt jobba dersom du har klart å henge med så langt!
...
Fordi me genererer fargar basert på kontrast, så er det ikkje alle fargetonar som oppfører seg likt for oss menneske.
