...
## Behagelege fargeskalaer for menneskerr
...
Me synst dette gav svært fine verdiar fordi det etterlikna korleis lys påverkar fargar i den verkelege verda og korleis me mennesker oppfattar dei.
...
Samanlikna med RGB-teknikken, så ser me at fargane vart mykje meir saturterte i dei øvre skalaene. 
Dette gjev meining fordi me ikkje har justert på satueringsverdiane. 
Dette viser veldig godt ei utfordring med mange av fargeromma som brukar lightness for å definere lysstyrka i fargen.
...
Luminansen skildrar den opplevde lysstyrka til ei flate og vert brukt til å vurdere kor mykje lys som vert reflektert
...
Målet vårt var å finne lysstyrkeverdiar i RGB-fargerommet ved å justere fargane gjennom «tinting» og «shading» heilt til me oppnådde den ønska luminansen
...
Målet er å finne luminansverdien `0.7` for begge fargane i RGB-fargerommet, som du kan sjå heilt til høgre.
...
I iterasjon 3 av blåfargen (fargen rett til venstre for resultatet) ser me at luminansverdien er `0.34`. 
...
Målet var å finne luminansverdien `0.7` for fargane. Men som biletet over viser vart resultatet `0.72` og `0.71`.
...
Fargane vert genererte ved å finne faste luminansverdiar i RGB-fargerommet. 
...
Desse gruppene bruka faste luminansverdiar i RGB-fargerommet for å definere kvart steg i skalaen.
...
I biletet over ser du 4 fargeskalaer som vert generert basert på dei 4 fargane som du finn i toppen av biletet.
...
Grunnen til at me brukar HSLuv er fordi me vil at fargane skal auke i lysstyrke med faste verdiar som opplevast som naturleg for auget.
