...
Vi skal nå se nærmere på språket vi bruker i varslene, og når vi bør bruke ulike typer varslinger. Til slutt tar vi for oss implementeringen i kode, med fokus på tilgjengelighet og hvordan vi bruker ARIA-attributter for å sikre at varslene fungerer optimalt for alle brukere, inkludert de som bruker skjermlesere.
...
- gi brukeren forslag til relevante sider basert på URLen
...
<Image
  ...
  boxShadow={true}
  caption='Full feilmeldingsside som forteller at denne siden kan være slettet eller flyttet, eller det er en feil i lenken. Vi gir brukeren mulighet til å søke etter informasjonen og foreslår noen sider som kan være aktuelle basert på lenken brukeren forsøkte å nå. '
/>
