...
3. Gå til [Temabyggeren](https://next.theme.designsystemet.no) og generer fargeskalaen ut i fra dine profilfarger. Behold samme fargenavn og ikke fjern farger (Dette fungerer bare med [alternativ 2](/grunnleggende/for-designere/eget-tema#alternativ-2-med-kobling).) 
...
En kobling gjør at du slipper å legge variablene inn i Figma, du importerer dem i stedet fra pluginen "Tokens Studio". Dette alternativet krever kjennskap til github-repositories.
