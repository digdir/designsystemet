...
Hvilket alternativ du går for avhenger av dine behov og rammer. Å sette opp en kobling krever en pro-versjon av pluginen [Tokens Studio](https://tokens.studio/) og en Github-bruker. Vi håper vi kan gjøre dette enklere med en egen plugin etter hvert.
