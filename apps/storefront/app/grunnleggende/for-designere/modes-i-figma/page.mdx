...
<Image
  ...
  boxShadow={false}
  caption='Eksempel 1: Dev Mode – Når hele framen er valgt.
'
/>

<Image
  src='/img/dev-mode-individuell-komponent.png'
  alt='Skjermbildet viser hvordan modes ser ut i figma i dev-mode når individuell komponent er valgt'
  boxShadow={false}
  caption='Eksempel 2: Dev Mode – Når individuell komponent er valgt
'
/>
