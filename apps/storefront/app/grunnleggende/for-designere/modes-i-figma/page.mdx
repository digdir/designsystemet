...
Designere kan enkelt bytte mellom ulike modes i Figma og se resultatet direkte i grensesnittet. De som har visningstilgang, vil ikke kunne se hvilken modes som er valgt - som tema, fargeoppsett eller typografi. Denne informasjonen er bare tilgjengelig for de som har redigeringstilgang, eller for de som bruker Dev Mode i Figma. Dev mode ser kun hvilken mode som er satt på elementet det er satt, ikke lenger nedover.

#### Slik ser det ut med visningstilgang (view only):
Her kan du se at informasjon om valgt mode ikke er synlig når du kun har visningstilgang.
...
Hvis en mode er satt på en hel frame, vises den kun i Dev mode når selve framen er valgt. Klikker du i stedet på en individuell komponent inne i framen, vil informasjonen om valgt mode ikke være synlig.
