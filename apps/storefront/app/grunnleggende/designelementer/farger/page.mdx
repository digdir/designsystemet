...
Fargene under er eksempler på hvordan fargene fra ditt tema vil se ut og hete.
Bruk [temavelgeren](https://theme.designsystemet.no) for å generere egne farger og navn.
