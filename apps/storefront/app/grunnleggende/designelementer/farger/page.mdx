...
* `Background-hover` kan brukes til hover-tilstander for bakgrunner eller til å skape visuelle hierarkier i bakgrunnslaget når den kombineres med Background-tinted.
### Surface
...
Base-fargene er delt inn i tre varianter: Base-default, Base-hover og Base-active.
