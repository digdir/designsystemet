...
Fargenavnene i Designsystemet er bygget opp av 3 ledd: Navn på fargeskala, gruppe (bruksområde) og variant.
Disse delene beskriver hvordan fargene er bygget opp og hvordan de skal brukes.
...
* `Background-hover` kan brukes til hover-tilstander for bakgrunner eller til å skape visuelle hierarkier i bakgrunnslaget når den kombineres med Background-tinted og Background-active.
### Surface
