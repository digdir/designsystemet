...
<Image
  ...
  boxShadow={false}
  dataUnstyled
  caption='Viser fargeskalaen til den grønne Success fargen og hvordan den er delt opp i grupper.'
/>
...
* `Base-default` kan brukes for å fargelegge solide bakgrunner til elementer. Fargen (hex-koden) som blir valgt i temabyggeren blir plassert i Base-default.
