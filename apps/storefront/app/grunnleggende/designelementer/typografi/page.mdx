...
For å presentere tekst på korrekt måte er det laget stiler som har ulike kombinasjoner av størrelse, fontvekt og linjehøyde. Det er også laget et sett med [typografi-komponenter](https://storybook.designsystemet.no/?path=/docs/komponenter-typography--docs) som wrapper typografi-stilene og har innebygd spacing.
