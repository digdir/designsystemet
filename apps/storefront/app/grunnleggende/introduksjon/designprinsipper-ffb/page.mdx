...
export const metadata = {
  ...
  description:
    'Forum for brukskvalitet har gjennomført en temasamling der det ble startet på å definere felles prinsipper mellom flere som jobber med brukskvalitet og brukeropplevelse i offentlig sektor.',
};
