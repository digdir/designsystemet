...
I noen sammenhenger bør vi tilby kontekst, for å presisere hva vi sletter, lukker eller endrer. For eksempel «Slett søknaden», «Lukk produktoversikt», «Endre profilbilde». De gangene vi ikke viser kontekst, men bare verb, burde kontekst være beskrevet i `aria-label` for skjermlesere.
