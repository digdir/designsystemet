...
/>
      ...
      <Section title='Siste nytt fra designsystemet'>
        ...
        <ImageBanner
          ...
          buttons={
            [
              { text: 'Ta kontakt', href: 'mailto:designsystem@digdir.no', prefix: <EnvelopeClosedIcon fontSize={24} /> }, { text: 'Bli med i Slack-kanalen', href: 'https://join.slack.com/t/designsystemet/shared_invite/zt-2438eotl3-a4266Vd2IeqMWO8TBw5PrQ',  prefix: (
        <img
