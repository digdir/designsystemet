...
Når brukerne har gjort en feil som hindrer dem i å komme videre, skal vi varsle dem om feilen slik at de kan rette opp. Meldingen skal beskrive problemet og forklare hva brukerne må gjøre for å komme videre. Vi må passe på at feilmeldingen er lett synlig og enkel å forstå.
...
- løsningen ikke stopper brukerne fra å gå neste side selv om de har feil på en side
...
- du lenker du til den første av flere feil
...
Feltet må ha 3:1 kontrast til bakgrunnsfargen. Hvis vi også bruker rød tekst til feilmeldingen, må den minst ha kontrasten 4.5:1.[Tilsynet for universell utforming av ikt's artikkel om kontraster](https://www.uutilsynet.no/veiledning/kontrast/48)
