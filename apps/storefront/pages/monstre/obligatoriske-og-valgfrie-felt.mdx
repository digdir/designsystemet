...
Hvis vi kan holde oss til ett spørsmål per side så er det aller enkleste for brukeren å forholde seg til. Gjør vi det, trenger vi ikke å markere hvilke felt som må fylles ut. Da kommer det frem av beskrivelsen at dette må fylles ut.
...
- Pass på at det ikke er for mange spørsmål på samme side. Det som ligger på samme side bør være innenfor samme tematikk og spørsmålene bør være relatert til hverandre.
  <Image
