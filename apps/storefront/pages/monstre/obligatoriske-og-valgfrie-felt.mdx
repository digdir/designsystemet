...
<Image
  ...
  alt='Skjermbilde av skjema med ett spørsmål på en side'
  boxShadow={false}
/>
...
En kombinasjon av obligatoriske og valgfrie felt er ikke ideellt! Men det vil være situasjoner der vi ikke kommer unna det. Hvis vi _må_ ha med valgfrie felt i tillegg til de obligatoriske, markerer vi alle feltene. Da trenger vi ikke å informere i toppen.
