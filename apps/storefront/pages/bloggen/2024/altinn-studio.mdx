...
export default ({ children }) => (
  <BlogArticleLayout
    ...
    ingress='Altinn Studio benytter seg av designsystemet.no ved hjelp av fasademønsteret. Lær mer om hvordan!'
    ...
    imageCaption='Komponentene fra Designsystemet er laget i Figma og i React. Bildet viser forsiden til biblioteket i Figma. '
  />
);
...
<Image
  ...
  boxShadow={false}
  imageCaption='Figur 1: Illustrasjon som viser varianter av knapper.'
/>
...
<Image
  ...
  boxShadow={false}
  imageCaption='Figur 2. Eksempel på en sammensatt komponent av flere komponenter fra designsystemet'
/>
...
<Image
  ...
  boxShadow={false}
  imageCaption='Figur 3. Illustrasjon som viser direkte avhengigheter til designsystemet.'
/>
...
<Image
  ...
  boxShadow={false}
  imageCaption='Figur 4.  Illustrasjon som viser isolering av designsystemet. Illustrasjonen viser også hvordan man kan håndtere breaking chnage, uten å mått endre de 4 side-komponentene.'
/>
