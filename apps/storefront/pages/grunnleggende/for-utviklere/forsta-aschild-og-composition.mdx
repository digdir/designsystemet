...
Flere Designsystemet komponentar støttar `asChild`, med standard element. Endres dette må du passe på at tilgjengelegheit er ivaretatt. Det er sjeldent at du behøver å endre det underliggande elementet, men det er meir realistisk at du vil bruke din eigen komponent.

Ønsker du å bruke ein eigen komponent må du passe på å spre alle props, og ha støtte for `ref`. [3]
...
Flere Designsystem komponenter støtter `asChild`.
