...
Ulempen er at det krever en del mer første gang du skal sette det opp, og du er avhengig av pluginen [Tokens Studio](https://tokens.studio/). Du må vurdere om det er verdt det for din organisasjon. _Uten direkte kobling til tokens_, må du manuelt passe på at variablene som lages i Figma er de samme som brukes i kode.
