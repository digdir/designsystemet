...
2. Lage en plugin som kan hente ned siste endringer. Du må evt. ha en [Enterprise-konto i Figma for å få tilgang til API'et du trenger](ttps://github.com/digdir/designsystemet/issues/289#issuecomment-2037555899). Si fra om du får det til!
