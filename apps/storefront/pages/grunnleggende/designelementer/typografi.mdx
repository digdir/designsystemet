...
<Card color='second'>
  <Card.Content>
    Hva med **_dynamiske font-størrelser_**? <br />
    Vi testet dynamisk font-størrelse uten breakpoints i et år. Det har fordeler
    og ulemper. Du kan fortsatt velge å bruke det ved å slå på settet &quot;fluid-typography&quot;,
    men som standard kommer Designsystemet nå med en statisk font-skala. Les mer
    om [Fluid typography, og hvorfor vi gikk bort fra det](/grunnleggende/designelementer/dynamisk-typografi).
  </Card.Content>
</Card>
