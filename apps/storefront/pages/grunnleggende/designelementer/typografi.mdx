...
Vi har totalt 10 størrelser i designsystemet. 12, 14, 16, 18, 21, 24, 30, 36, 48 og 60px. Default tekststørrelse for `paragraph` er `medium` som tilsvarer 18px. Komponenter i `medium` størrelse vil også ha tekststørrelse f1 (18px).
...
<Card color='second'>
  <Card.Content>
    Hva med **_dynamiske font-størrelser_**? <br/>Vi testet dynamisk font-størrelse uten breakpoints i et år. Det har fordeler og ulemper. Du kan fortsatt velge å bruke det ved å slå på settet "fluid-typography", men som standard kommer Designsystemet nå med en statisk font-skala. Les mer om [Fluid typography, og hvorfor vi gikk bort fra det](/grunnleggende/designelementer/dynamisk-typografi).
  </Card.Content>
</Card>
