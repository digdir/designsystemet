...
Vi har testet dynamisk font-størrelse uten breakpoints, og det var default i Designsystemet det meste av Beta-perioden. Dynamiske font-størrelser, eller "_Fluid typography"_ har fordeler og ulemper, noe som gjorde vi måtte revurdere bruken av det.  Du kan fortsatt velge å bruke det ved å slå på settet "[fluid](https://github.com/digdir/designsystemet/blob/main/design-tokens/Base/Fluid.json)"
    men som standard kommer Designsystemet nå med en statisk font-skala. 
    
    **Les mer om [Fluid typography, og hvorfor vi gikk bort fra det](/grunnleggende/designelementer/dynamisk-typografi)**.
