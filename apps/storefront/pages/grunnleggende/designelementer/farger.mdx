...
Fargesystemet består av globale farger som refererer til hva fargen er (eks. Red-500) og et semantisk nivå som beskriver hva fargen skal brukes til (eks. Text.Danger). Les mer om [fargesystemet og hvilke prinsipper det er bygget på](/grunnleggende/for-designere/grunnleggende/for-designere/fargesystem).
