...
[Flere offentlige etater har egne designsystem](https://github.com/digdir/designsystem/wiki/Kartlegge-eksisterende-offentlige-designsystem) i dag. Problemet er at vi utvikler hvert vårt designsystem i hver vår organisasjon, med ulike retningslinjer, komponenter og mønstre. Dette fører til fragmenterte og lite helhetlige brukeropplevelser på tvers av offentlig sektor.
