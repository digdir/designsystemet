  ...
  return (
    <div className={classes.dashboard}>
      ...
      <div className={classes.content}>
        <Heading size="xsmall" className={classes.title}>
          Dashboard
        </Heading>
        <div className={classes.grid}>
          <div className={cn(classes.colorCardsContainer, classes.card)}>
            <Heading size="xxsmall" className={classes.cardTitle}>
              Grafikk one
            </Heading>
            <Paragraph size="small" className={classes.cardDesc}>
          ...
          <div className={cn(classes.users, classes.card)}>
            ...
            <div className={classes.usersContainer}>
              ...
              <div className={classes.user}>
                <img src="img/avatars/male1.png" alt="" />
                <div className={classes.userTextContainer}>
