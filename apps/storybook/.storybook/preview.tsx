...
const components = {
  ...
  h1: (props) => <HeadingSelfLink data-font-size='lg' {...props} level={1} />,
  h2: (props) => <HeadingSelfLink data-font-size='md' {...props} level={2} />,
  h3: (props) => <HeadingSelfLink data-font-size='sm' {...props} level={3} />,
  h4: (props) => <HeadingSelfLink data-font-size='xs' {...props} level={4} />,
  h5: (props) => <HeadingSelfLink data-font-size='xs' {...props} level={5} />,
  h6: (props) => <HeadingSelfLink data-font-size='xs' {...props} level={6} />,
  p: (props) => (
    <Paragraph
      {...props}
