...
async function updateIndexSettings() {
  try {
    ...
    console.log(
      ...
      currentSettings.filterableAttributes || 'None',
    );
    console.log(
      '  Searchable attributes:',
      currentSettings.searchableAttributes || 'All',
    );
    console.log(
      '  Sortable attributes:',
      currentSettings.sortableAttributes || 'None',
    );
    console.log('');
    ...
    console.log(
      `✅ Filterable attributes task queued: ${filterableTask.taskUid}`,
    );
    ...
    console.log(
      '  • Filter by type: filter(type = "component") for components only',
    );
    console.log(
      '  • Filter by language: filter(lang = "en") for English docs only',
    );
    console.log(
      '  • Filter by URL patterns: filter(url CONTAINS "storybook") for component docs',
    );
    console.log(
      '  • Sort results by title or file path for better organization',
    );
    console.log('');
