...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      <TableCell>
        [Rediger](https://github.com/digdir/designsystemet/blob/main/web/www/app/content/patterns/no/external-links.mdx) (sier ingenting om hva som redigeres eller hvor)
      </TableCell>
      <TableCell>
       [Rediger denne siden på github.com](https://github.com/digdir/designsystemet/blob/main/web/www/app/content/patterns/no/external-links.mdx)
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
