...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      <TableCell>
        [Edit](https://github.com/digdir/designsystemet/blob/main/web/www/app/content/patterns/en/external-links.mdx) (Says nothing about what or where)
      </TableCell>
      <TableCell>
        [Edit this page on github.com](https://github.com/digdir/designsystemet/blob/main/web/www/app/content/patterns/en/external-links.mdx)
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
