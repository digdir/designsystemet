...
**Dialog**: `data-placement` selector styles the Dialog as a drawer component from the direction given (`left | right | top | bottom` or `center` which is the default Dialog)
