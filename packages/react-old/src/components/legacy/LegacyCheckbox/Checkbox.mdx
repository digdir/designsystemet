import { Meta, Canvas, ArgTypes, Controls, Primary } from '@storybook/blocks';
...
<Information
  text='deprecated'
  description='**Denne komponenten er erstattet av ny [Checkbox](/?path=/docs/komponenter-checkbox--docs) komponent.**'
/>
