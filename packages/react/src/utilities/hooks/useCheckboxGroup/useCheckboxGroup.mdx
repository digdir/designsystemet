...
I `getCheckboxProps` denne funksjonen er første parameter `value` som er en unik identifikator for checkboxen, eller et objekt med alt som kan legges på en checkbox.
