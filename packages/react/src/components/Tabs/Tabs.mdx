...
For å sikre at brukeren lett forstår hva de kan forvente, bør `tab`-ene være korte og beskrivende. Hvis det er vanskelig å lage presise `tab`-er, kan det tyde på at innholdet ikke er godt strukturert.
