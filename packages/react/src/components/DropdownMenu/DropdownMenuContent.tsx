...
export const DropdownMenuContent = forwardRef<HTMLUListElement, DropdownMenuContentProps>(
  ({ className, children, ...rest }, ref) => {
    const { size, placement, portal, anchorEl, isControlled, internalOpen, setInternalOpen, onClose } =
