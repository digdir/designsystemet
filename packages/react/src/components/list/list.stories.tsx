...
export const Sortert = meta.story({
  render: (args) => (
    <>
      <Heading
        level={2}
...
export const Usortert = meta.story({
  render: (args) => (
    <>
      <Heading
        level={2}
...
export const Innrykk = meta.story({
  render: (args) => (
    <>
...
export const ListeMedLenker = meta.story({
  render: (args) => (
...
export const ListeMedOverskrift = meta.story({
  render: () => (
    <>
      <div>
        <Heading
