...
`Table` brukes for å vise store mengder strukturert informasjon på en ryddig og oversiktlig måte. Tabller kan gjøre det enklere for brukerne å skanne og sammenligne informasjon.   
