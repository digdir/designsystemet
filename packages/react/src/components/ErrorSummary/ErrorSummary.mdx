...
Error summary kalles feiloppsummeringer på norsk. Det gir brukeren oversikt over feil eller 
mangler som må rettes på en side eller trinn, før man kan komme videre.
...
Oppsummeringen vises øverst på siden, trinnet under headeren, men over den øverste overskriften på siden.
Dette er viktig dersom siden blir lastet inn på nytt etter brukeren har sendt inn skjemaet.
...
skal fokus flyttes til det feltet som feilmeldingen gjelder.
...
- Hvis vi validerer fortløpende (feks. ved onBlur på hvert felt), venter vi med å vise ErrorSummary til brukeren prøver å sende inn skjemaet (submit).
- Det er viktig at komponenten får fokus ved submit slik at brukeren får med seg at det er feil eller mangler i skjemaet. 
Fokus gjør at brukeren blir sendt til komponenten, og skjermleserbrukere får overskriften lest opp.
