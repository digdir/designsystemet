...
`ErrorSummary` brukes til å vise en oppsummering når det er feil eller mangler i noe brukeren har gjort. En oppsummering kan gjelde for én eller flere feil.
 ...
 Brukerne skal kunne gå direkte til feilene de må rette opp ved å klikke på lenkene i oppsummeringen, og det er viktig at disse lenkene stemmer overens med feilmeldingene de viser til.
