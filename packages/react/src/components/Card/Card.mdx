...
<Card>
  <Card.Section>Tittel</Card.Section>
  <Card.Section>Innhold</Card.Section>
  <Card.Section>Valgfri fotnote</Card.Section>
</Card>;
```
...
Bruk`Card.Section` hvis du vi ha bilder eller video i kortene.
