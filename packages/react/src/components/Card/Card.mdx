...
Bruk `as` til å endre kortet til en lenke. Hover og aktivt styling blir kun aktivert dersom `href` er definert.
Vær oppmerksom på gyldig html [innhold](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a#technical_summary) dersom du endrer kortet til å være en lenke.
