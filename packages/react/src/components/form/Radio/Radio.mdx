...
Bruk `inline` for å plassere alternativene på samme linje. Vi anbefaler å kun bruke dette dersom du har kun to alternativer og kort label, som i f.eks typisk ja/nei spørsmål
