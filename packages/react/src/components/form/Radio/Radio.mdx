...
Vi ha opptil syv alternativer i en gruppe. Da viser vi dem helst på hver sin linje vertikalt, så det blir lett å skanne. Hvis vi bare har to valg med korte ledetekster (`labels`), kan vi vise dem ved siden av hverandre.
