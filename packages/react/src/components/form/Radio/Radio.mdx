...
`Radio` skal som hovedregel *ikke* plasseres på samme linje, men hvis du har kun to alternativer med korte tekster som "Ja" og "Nei" kan du vurdere å plassere dem ved siden av hverandre. 
