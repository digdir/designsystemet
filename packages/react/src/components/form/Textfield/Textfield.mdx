...
Ønsker du mer kontroll eller funksjonalitet bruk [Field](/docs/komponenter-field--docs) komponenten direkte.
...
Sett sammen [Field](/docs/komponenter-field--docs#antall-tegn) til å vise antall tegn som er skrevet i et tekstfelt.
