...
Plasser både forklaringen (legend) og eventuell hjelpetekst brukeren trenger for å forstå oppgaven, før `checkbox`-gruppen kommer. I et skjema er ofte forklaringen formulert som et spørsmål. Vurder om du trenger å ha med informasjon om at brukeren kan velge flere svaralternativer. Ledeteksten til hver boks (label) må beskrive alternativet.
