...
Bruk `asChild` dersom du trenger å bruke knappen som en lenke. Vurder først om det er bedre å bruke [`Link`](/docs/felles-link--docs)-komponenten.
...
- navigere til andre sider eller ut av tjenesten, bruk heller [`link`](/docs/felles-link--docs)

<br />

### Plassering av knapper

Når vi legger flere knapper ved siden av hverandre, skal primærknappen stå først. Unntaket er Forrige og Neste, da skal sekundærknappen Forrige stå først, for å unngå språklig forvirring.
