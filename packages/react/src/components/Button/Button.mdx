...
Når du bruker ikon må du sette størrelsen på ikonet selv. Vi anbefaler å brukse disse verdiene for [Aksel](https://aksel.nav.no/ikoner) sine ikoner:

| Størrelse på Button | fontSize |
| :------------------ | :------- |
| small               | 1rem     |
| medium              | 1.5rem   |
| large               | 2rem     |
