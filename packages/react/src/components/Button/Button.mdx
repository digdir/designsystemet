...
Sett `as="a"` dersom du trenger å bruke knappen som en lenke. Vurder først om det ikke holder å bruke [Link](/docs/komponenter-link--docs) komponenten.

<Canvas of={ButtonStories.UsedAsLink} />
