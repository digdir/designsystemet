...
Når vi skal vise brukaren at knappen held på å laste noko, kan vi kombinere knappen med ein spinner. I ekempelet under bruker vi proppen `loading` for å vise at knappen lastar.
