...
I tillegg til disse retningslinjene, bør du også følge de generelle retninglinjene for [`textfield`](/docs/komponenter-Textfield--docs) og [`input`](/docs/komponenter-input--docs). 
...
* [Tekst](/docs/komponenter-textfield--docs#tekst)
