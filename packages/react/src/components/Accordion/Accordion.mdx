...
Som standard er `Accordion.Header` et `h1` element. Du må selv velge riktig overskriftsnivå for din side. Hvis `Accordion.Header` er en del av en større overskrift, kan du bruke `h2`, `h3` osv. for å opprettholde en logisk rekkefølge.
