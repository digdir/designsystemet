...
import * as DetailStories from './Detail/Detail.stories';
...
<Canvas of={DetailStories.Preview} />
<Controls of={DetailStories.Preview} />
...
<Canvas>
  <Story of={typographyStories.EksempelTekst} />
</Canvas>
