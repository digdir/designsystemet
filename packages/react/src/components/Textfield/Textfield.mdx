...
- Velg inputtyper som samsvarer med informasjonen du ber om, for eksempel `tel` eller `email`. Dette gir mobilbrukere et tilpasset tastatur, men vær oppmerksom på at enkelte inputtyper kan aktivere klientsidevalidering. 
