...
`Breadcrumbs` kan ha flere interaktive elementer må navigeres over med tastaturet. 
Pass derfor på at du legger inn at `[SkipLink](/?path=/docs/komponenter-skiplink--docs)` til 
