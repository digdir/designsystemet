...
<Canvas of={AlertStories.WrongLiveRegion} />
...
For dynamiske varsler uten React, følg eksempelet i [mønsteret for dynamiske systemvarsler](https://www.designsystemet.no/monstre/systemvarsler#dynamiske-varsler).
