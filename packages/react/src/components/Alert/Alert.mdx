...
Du kan legge på `role=alert` men var opperksom på forventet oppførsel dette medfører. Les mer om dette på [W3 Alert pattern](https://www.w3.org/WAI/ARIA/apg/patterns/alert/)
