...
export const WithChipsOutside = meta.story({
  render: (args) => {
    const [value, setValue] = useState<string[]>([]);
...
export const ThousandsOfOptions = meta.story({
  render: (args) => {
    return (
      <Combobox {...args}>
        <Combobox.Empty>Fant ingen treff</Combobox.Empty>
...
export const RemoveAllOptions = meta.story({
  render: (args) => {
...
export const WithNumberValues = meta.story({
  render: (args) => {
    return (
