  ...
  return (
    <Table {...args}>
      ...
      <Table.Body>
        <Table.Row>
          <Table.Cell>
            <Checkbox aria-label='Velg Kari Nordmann' data-clickable='row' />
          </Table.Cell>
        ...
        <Table.Row>
          <Table.Cell>
            <Button data-clickable='row' onClick={() => alert('Knappeklikk')}>
              Knapp
            </Button>
          </Table.Cell>
        ...
        <Table.Row>
          <Table.Cell>
            <Link href='https://designsystemet.no' data-clickable='row'>
              Lenke
            </Link>
          </Table.Cell>
