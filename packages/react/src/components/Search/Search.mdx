...
* `ESC`-tasten tømmer søkefeltet for en enhetlig opplevelse på tvers av nettlesere.
* `Tab`-navigasjon lar brukere bevege seg mellom inputfelt, clear-knapp og søkeknapp.
