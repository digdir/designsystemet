...
## Kjente mangler
I Firefox og Safari (macOS og iOS) spilles det ikke av animasjon når `Details` åpnes og lukkes. 
Se [interpolate-size på MDX](https://developer.mozilla.org/en-US/docs/Web/CSS/interpolate-size).
