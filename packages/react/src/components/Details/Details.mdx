...
`Details` kan vises med ramme. Dette kan passe i tilfeller der detailss ikke fyller hele siden, eller når det kun er en rad.

<Canvas of={DetailsStories.DetailsBorder} />

### Med farger

`Details` kan vises i farger fra ditt brand.

<Canvas of={DetailsStories.DetailsColor} />

#### Kontrollert

`Details` har egen tilstand på åpen/lukker, men dette kan kontrolleres utenfra.
