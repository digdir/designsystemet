...
Hoppelenke-komponenten er designet for å hjelpe de som bruker tastatur og skjermleser, med å hoppe over gjentakende innhold og raskt få tilgang til viktige seksjoner eller funksjoner på en nettside.
