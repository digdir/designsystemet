...
Elementet som åpner `popover` bør bruke `aria-expanded="true/false"` for å indikere om `popover` er åpen eller lukket. Det er innebygd tilgjengelighet i Popover APIet i henhold til åpne/lukket tilstand og tastaturnavigasjon.
