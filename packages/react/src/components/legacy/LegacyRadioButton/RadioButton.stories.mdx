...
import { RadioButtonSize } from '../../../types/enums';
...
<Meta
  ...
  argTypes={{
    ...
    size: {
      ...
      control: {
        type: 'radio',
        options: [RadioButtonSize.Small, RadioButtonSize.Xsmall],
      },
...
<Information
  text='deprecated'
  description='**Denne komponenten er erstattet av ny [Radio](/docs/kjernekomponenter-radio--docs) komponent.**'
/>
