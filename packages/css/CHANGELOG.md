...
- **Details:** Using `margin` instead `padding` to style children of `Details` to allow direct children such as `Button` ([#3883](https://github.com/digdir/designsystemet/pull/3883))
