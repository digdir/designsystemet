...
export default () =>
  cssVarCodemod({
    ...
    '--fds-typography-interactive-large': '[delete]',
    '--fds-typography-interactive-medium': '[delete]',
    '--fds-typography-interactive-small': '[delete]',
    '--fds-border_radius-interactive': '[delete]',
