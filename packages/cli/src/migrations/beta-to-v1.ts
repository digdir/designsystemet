  ...
  runCssCodemod({
    ...
    plugins: [
      ...
      cssVarRename({
        ...
        '--fds-semantic-sunerface-neutral-subtle': '--ds-color-neutral-background-subtle',
        '--fds-semantic-surface-neutral-subtle-hover': '--ds-color-neutral-surface-default',
        '--fds-semantic-surface-neutral-dark': '--ds-color-neutral-border-default',
        '--fds-semantic-surface-neutral-dark-hover': '--ds-color-neutral-border-strong',
