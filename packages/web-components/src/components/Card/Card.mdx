...
```tsx
import { Card } from '@digdir/designsystemet-web-components';
<ds-card>
  <ds-card-block>Tittel</ds-card-block>
  <ds-card-block>Innhold</ds-card-block>
  <ds-card-block>Valgfri fotnote</ds-card-block>
</ds-card>;
```
...
I dette eksempelet rendrer Card som lenke `<a>`. Dette er nyttig når Card inneholder lite tekst, og skal navigere til en annen side.
