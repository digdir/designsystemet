...
Når vi utvikler nye produkter eller forbedrer eksisterende er det lurt å følge noen designprinsipper slik at vi er sikre på at vi leverer brukervennlige tjenester til innbyggerne i Norge.

## Et felles sett designprinsipper?

Målet er at vi kan utvikle et sett med felles designprinsipper som vi bruker på tvers og som kontinuerlig videreutvikles og tilpasses i fellesskap. Det er viktig at vi utforsker og forstår helheten av offentlige tjenester sammen.

### Hvilke opplevelse vil vi gi brukerne?
...
- **Sørg for at tjenesten inkluderer alle** \
...
- Brønnøysundregistrene: [15 prinsipper for god tjenestedesign](/god-praksis/brukerinnsikt/brreg-15-prinsipper-for-god-tjenestede.pdf)
- Brønnøysundregistrene: [11 prinsipper for bra design - Brønnøysundregistrene](/god-praksis/brukerinnsikt/brreg-11-prinsipper-for-bra-design.pdf)
- Brønnøysundregistrene: [Brønnøysundregistrenes brukskvalitetspolicy](https://brukskvalitet.brreg.no/brukskvalitet/)
- Digdir: [Designprinsipper Dødsfall og Arv](/god-praksis/brukerinnsikt/designprinsipperDOA.pdf)
- Nav: [Prinsipper for brukeropplevelse](https://aksel.nav.no/prinsipper/brukeropplevelse)
- Helsenorge: [Designprinsipper for Helsenorge](/god-praksis/brukerinnsikt/designprinsipperHelsenorge.png)
...
- Forum for brukskvalitet: [Prinsipper for samarbeid i offentlig sektor](designprinsipper-ffb)
...
- Netlife Blogg: [5 prinsipper for god brukeropplevelse](https://www.netlife.com/blogg/5-prinsipper-for-god-brukeropplevelse-ux)
  [Bidra til denne oversikten](https://github.com/digdir/designsystem/tree/main/storefront/pages/god-praksis/brukerinnsikt/designprinsipper)
