import { Meta, Banner, Section, NavigationCard } from '@components';
...
<Banner
  ...
  desc='Felles designsystem består av grunnleggende designelementer, komponenter og mønstre du kan bruke når du utvikler tjenester. Vi håper dette kan bli en felles verktøykasse der vi samarbeider på tvers om å lage det beste grunnlaget for offentlige tjenester.'
></Banner>
