...
Ønsker du å foreslå en ny komponent setter vi pris på om den blir [registrert i Github](https://github.com/digdir/designsystem/issues/new?assignees=&labels=needs+prioritization%E2%9D%97%EF%B8%8F&projects=&template=3propose_a_new_component.yml). Lim gjerne inn skjermbilder av behovet eller lenk til relevant side i [sandkassen](https://www.figma.com/file/hCLf6YzvQF15WPFFpXqeJj/Sandkasse?type=design&node-id=1%3A4&mode=design&t=5bHSaO1ULo9gKrkK-1).

Når en ny komponent blir foreslått må vi vurdere om den er verdifull nok til å være en del av designsystemet. Vi ønsker ikke å ende opp med hundrevis av komponenter med små forskjeller, da vi kan risikere uønsket kompleksitet, samt design- og teknologigjeld.
