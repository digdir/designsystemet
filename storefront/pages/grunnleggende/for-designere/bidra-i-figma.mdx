...
- Snakk med en utvikler om spesifikasjon, krav, egenskaper og varianter. Bli enige om scope for komponenten.
...
- Når komponenten er klar markeres den som "Ready for review". Den blir testet av andre og etter eventuelle justeringer markeres den som "Ready for dev". Når den er utviklet som en React-komponent lenker vi til siden i Storybook.
