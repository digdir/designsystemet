...
<Meta
  title='Prinsipper for designsystemet'
...
Designsystemet skal inneholde alt som gir verdi å dele på tvers og det bør utvikles i samarbeid mellom offentlige aktører. Designsystemet skal være levende. Vi skal sammen sørge for å oppdatere det hvis teknologiutviklingen, brukerbehov eller krav for universell utforming gjør det nødvendig å endre noe.

For å oppnå dette har vi laget noen prinsipper vi ønsker å bygge designsystemet på.

### Kvalitet

Designsystemet skal holde høy kvalitet, og gjøre det effektivt å lage digitale produkter med god kvalitet. Med god kvalitet mener vi både noe som gir en god brukeropplevelse, men også har et godt teknisk fundament. Det vi lager skal være tilgjengelig for alle, uansett varige eller midlertidig reduserte evner. Alle komponentene skal oppfylle kravene til universell utformingen, for eksempel universell utforming og helst mer enn det som er lovpålagt.
