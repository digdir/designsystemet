...
In the example above we use `!important` to set `font-feature-settings`. We reccommend this because we are using the [font](https://developer.mozilla.org/en-US/docs/Web/CSS/font) shorthand.
